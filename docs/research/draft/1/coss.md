...
Request For Comments specification process managed by Logos Research
...
For example, this specification should be **lip.logos.co/research/draft/1/coss**,
...
For example, this specification is **lip.logos.co/research/draft/1/coss**.
...
Logos Research is a department under the IFT organization that provides RFC (Request For Comments)
