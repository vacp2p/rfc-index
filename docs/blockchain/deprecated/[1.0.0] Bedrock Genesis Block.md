# [1.0.0] Bedrock Genesis Block

| Field | Value |
| --- | --- |
| Name | [1.0.0] Bedrock Genesis Block |
| Slug | 237 |
| Status | deprecated |
| Type | RFC |
...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.0.0] Bedrock Genesis Block.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
- **2026-05-25** — [`3577608`](https://github.com/logos-co/logos-lips/blob/357760810249c11860aa034d7015df58830513bd/docs/blockchain/raw/bedrock-genesis-block.md) — fix(blockchain): recover list-nested table, callout, and toggle content
- **2026-05-25** — [`312928c`](https://github.com/logos-co/logos-lips/blob/312928c26c2560c7805bf097640de36443f32776/docs/blockchain/raw/bedrock-genesis-block.md) — fix(blockchain): correct content-swapped specs, fill missing renderers, drop unrecoverable PR #2B targets
- **2026-05-25** — [`cdacf35`](https://github.com/logos-co/logos-lips/blob/cdacf3574287690650c2719b66927b51f5916156/docs/blockchain/raw/bedrock-genesis-block.md) — fix(blockchain): drop Notion chrome residue in 17 sync'd specs
- **2026-05-25** — [`7bf533d`](https://github.com/logos-co/logos-lips/blob/7bf533d211617763194453c0276c336b0b53a70e/docs/blockchain/raw/bedrock-genesis-block.md) — fix(blockchain): rewrite 17 sync'd spec bodies with DOM-aware converter
- **2026-05-22** — [`6dd2503`](https://github.com/logos-co/logos-lips/blob/6dd2503bbb151775e701e0c73c04366a3842ce9a/docs/blockchain/raw/bedrock-genesis-block.md) — chore(blockchain): sync 17 spec bodies from Notion source of truth (PR #2B)
...
In order to participate in the Cryptarchia lottery, stakeholders must generate their note keys in accordance with the Proof of Leadership protocol specified at [[1.0.0] Proof of Leadership - Protocol](https://nomos-tech.notion.site/Protocol-21c261aa09df819ba5b6d95d0fe3066d?pvs=24#21c261aa09df8162a035efaf3581702a).
...
- DA  [NomosDA Specification - Minimum Network Size](https://nomos-tech.notion.site/Minimum-Network-Size-1fd261aa09df81188e76cb083791252d?pvs=24#232261aa09df8018b5a3cc3539b177e6)
- Blend  [[1.0.0] Blend Protocol - Minimal Network Size](https://nomos-tech.notion.site/Minimal-Network-Size-215261aa09df81ae8857d71066a80084?pvs=24#232261aa09df80b9ba20ec70636e0db6)
...
- genesis_epoch_nonce: 32 bytes, hex encoded.
    The initial source of randomness for the Cryptarchia lottery. The process for selecting this value is described in detail at [Epoch Nonce Ceremony](https://nomos-tech.notion.site/Epoch-Nonce-Ceremony-21d261aa09df80bb8dc3c768802eb527?pvs=24#222261aa09df80c4a164e13249a57fcb).
...
1. $\mathbb{C}_\text{LEAD}$: Eligible leader commitment is set to the the Ledger Root over all notes from the initial token distribution. The derivation of this root is specified in [[1.0.0] Proof of Leadership - Ledger Root](https://nomos-tech.notion.site/Ledger-Root-21c261aa09df819ba5b6d95d0fe3066d?pvs=24#22b261aa09df801bbae2dd4ab6c04276).
