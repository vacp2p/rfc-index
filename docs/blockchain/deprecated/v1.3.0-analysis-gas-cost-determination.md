...
The Execution Gas of the Transfer Operation compensates for the verification of the [Mantle - Zero Knowledge Signature Scheme (ZkSignature)](v1.3.0-mantle.md#zero-knowledge-signature-scheme-zksignature) proof.
