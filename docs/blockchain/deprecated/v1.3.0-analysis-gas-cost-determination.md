...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/v1.3.0-analysis-gas-cost-determination.md) — chore: move blockchain specs from notion to github
...
| 1.3.0 |  Added [\[RFC\] Make Ledger Transaction an Operation](../raw/mantle-transaction-encoding/appendices/rfc-make-ledger-transaction-an-operation.md).    Renamed Nomos to Logos Blockchain | 2026-04-02 |
...
and come from our implementation observations as described in [Gas determination from measures](v1.3.0-analysis-gas-cost-determination.md#gas-determination-from-measures).  To get these numbers, we based our calculations on the following measures:
...
The Execution Gas of the Transfer Operation compensates for the verification of the [\[1.3.0\] Mantle - Zero Knowledge Signature Scheme (ZkSignature)](v1.3.0-mantle.md#zero-knowledge-signature-scheme-zksignature) proof.
...
![Diagram](v1.3.0-analysis-gas-cost-determination/assets/330261aa-09df-8197-8314-e128b166e4e5.png)
...
![Diagram](v1.3.0-analysis-gas-cost-determination/assets/330261aa-09df-8114-a634-f0fb05779717.png)
