# [1.2.0] Mantle Transaction Encoding
...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.2.0] Mantle Transaction Encoding.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
...
| 1.1.0 | Added [[RFC] Make Ledger Transaction an Operation](https://nomos-tech.notion.site/RFC-Make-Ledger-Transaction-an-Operation-31e261aa09df80bc9e02ea4e9affc082?pvs=24) | 2026-04-02 |
| 1.2.0 | Added [[RFC] Add Deposit/Withdraw to Tx Encoding](https://nomos-tech.notion.site/RFC-Add-Deposit-Withdraw-to-Tx-Encoding-335261aa09df80c8a881ccfc9f64eccd?pvs=24) | 2026-04-13 |

# Introduction

This document specifies the canonical encoding of Mantle transactions (see [[1.3.0] Mantle - Mantle Transaction](https://nomos-tech.notion.site/Mantle-Transaction-330261aa09df80a899a6efd74f12a7c4?pvs=24#330261aa09df81dbbfcbfe0983f7ff43)) and its sub-components. Transactions sent through the mempool and included in blocks use this encoding.
