...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/raw/digital-signature.md) — chore: move blockchain specs from notion to github
- **2026-05-18** — [`58b5698`](https://github.com/logos-co/logos-lips/blob/58b56988429f4d69a9e10a9fc118725e229e37c5/docs/blockchain/raw/digital-signature.md) — chore(blockchain): migrate contributor emails to @logos.co (#338)
...
used across different components in the Logos Blockchain system design.
Throughout the system, each Logos Blockchain layer shares the same signature scheme,
...
The Logos Blockchain Bedrock consists of a few key components that Logos Blockchain network is built on.
See the [Logos Blockchain whitepaper][logos-blockchain-whitepaper] for more information.
The Bedrock Mantle component serves as the operating system of Logos Blockchain.
...
This component also defines how Logos Blockchain Zones update their state and
the coordination between the Logos Blockchain zone executor nodes.
...
It is an execution layer that connects Logos Blockchain services
to provide the necessary functionality for sovereign rollups and zones.
See [Common Ledger specification][common-ledger] for more on Logos Blockchain Zones.
...
This document describes the validation tools that are used with Bedrock services in the Logos Blockchain network.
...
Logos Blockchain uses the Ed25519 instance with Curve25519,
...
- [Logos Blockchain whitepaper][logos-blockchain-whitepaper] - The Logos Blockchain Whitepaper
...
[logos-blockchain-whitepaper]: digital-signature/appendices/the-logos-blockchain-whitepaper.md
[common-ledger]: digital-signature/appendices/common-ledger-specification.md
