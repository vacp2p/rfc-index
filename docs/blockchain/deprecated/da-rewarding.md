...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/da-rewarding.md) — chore: move blockchain specs from notion to github
- **2026-05-18** — [`58b5698`](https://github.com/logos-co/logos-lips/blob/58b56988429f4d69a9e10a9fc118725e229e37c5/docs/blockchain/deprecated/da-rewarding.md) — chore(blockchain): migrate contributor emails to @logos.co (#338)
- **2026-01-30** — [`0ef87b1`](https://github.com/logos-co/logos-lips/blob/0ef87b1ba9491c854e48c8dfd7574d34ec69c704/docs/blockchain/deprecated/da-rewarding.md) — New RFC: CODEX-MANIFEST (#191)
- **2026-01-30** — [`3f76dd8`](https://github.com/logos-co/logos-lips/blob/3f76dd87a0b6580c16caa401c7fd5ec7dd9a7d6b/docs/blockchain/deprecated/da-rewarding.md) — Add NomosDA Rewarding specification (#269)
...
for the DA Network (Logos Blockchain Data Availability) service.
...
**Keywords:** DA Network, data availability, rewarding, incentives, peer evaluation,
...
The DA Network service is a crucial component of the Logos Blockchain architecture,
...
by integrating with the existing Logos Blockchain architecture
...
1. **Session $s$**: DA Network nodes perform sampling of data blobs referenced in blocks.
...
that aligns with Logos Blockchain' architectural goals.
...
- [DA Rewarding][origin-ref] - Original specification document
