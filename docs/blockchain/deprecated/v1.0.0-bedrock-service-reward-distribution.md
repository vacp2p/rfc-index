...
1. Service Activity Tracking (Session N+1): Service validators submit signed activity messages to attest to their participation of session N through a Mantle Transaction, including an activity message (see [\[1.0.0\] Mantle - SDP_ACTIVE](v1.0.0-mantle.md#sdp_active)).
