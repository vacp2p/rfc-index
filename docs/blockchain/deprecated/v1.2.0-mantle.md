...
Channel Inscribe Operations have a fixed Execution Gas cost of EXECUTION_CHANNEL_INSCRIBE_GAS. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
...
Channel Config Operations have a linear Execution Gas cost equal to EXECUTION_CHANNEL_CONFIG_GAS * configuration_threshold. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
...
Channel Deposit Operations have a fixed Execution Gas cost of EXECUTION_CHANNEL_DEPOSIT_GAS. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
...
Channel Withdraw Operations have a linear Execution Gas cost equal to EXECUTION_CHANNEL_WITHDRAW_GAS * withdraw_threshold. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
...
SDP Declare Operations have a fixed Execution Gas cost of EXECUTION_SDP_DECLARE_GAS. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
...
SDP Withdraw Operations have a fixed Execution Gas cost of EXECUTION_SDP_WITHDRAW_GAS. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
...
Leader Claim Operations have a fixed Execution Gas cost of EXECUTION_LEADER_CLAIM_GAS. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
...
Ledger Transactions have a fixed Execution Gas cost of EXECUTION_LEDGER_TX_GAS. See [\[1.2.0\] \[Analysis\] Gas Cost Determination](v1.2.0-analysis-gas-cost-determination.md) for the Execution Gas values.
