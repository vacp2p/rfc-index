...
This document defines an implementation-friendly specification of the Proof of Quota (PoQ), which is introduced in [\[1.0.0\] Blend Protocol - Proof of Quota](../raw/blend-protocol.md#proof-of-quota).
...
Here we use two hashes because the selection randomness is used in the Proof of Selection in order to prove the ownership of a valid PoQ (see [\[1.0.0\] Blend Protocol - Proof of Selection](../raw/blend-protocol.md#proof-of-selection)).
