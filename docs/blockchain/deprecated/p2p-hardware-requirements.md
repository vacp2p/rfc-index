...
- **2026-05-18** — [`58b5698`](https://github.com/logos-co/logos-lips/blob/58b56988429f4d69a9e10a9fc118725e229e37c5/docs/blockchain/raw/p2p-hardware-requirements.md) — chore(blockchain): migrate contributor emails to @logos.co (#338)
...
1. **Basic connectivity** to the Logos Blockchain network via [libp2p](https://docs.libp2p.io/)
