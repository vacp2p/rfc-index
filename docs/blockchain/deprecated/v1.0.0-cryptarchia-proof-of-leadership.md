...
- [Cryptarchia Protocol](../raw/cryptarchia-v1-protocol.md).
...
1. The epoch nonce: $\eta$.
    - For details see [Cryptarchia Protocol - Epoch Nonce](../raw/cryptarchia-v1-protocol.md#epoch-nonce).
...
1. The root of the note Merkle tree when the stake distribution was frozen $ledger_\text{AGED}$.
    - For details see [Cryptarchia Protocol - Epoch State Pseudocode](../raw/cryptarchia-v1-protocol.md#epoch-state-pseudocode).
...
1. The entropy contribution $\rho_{LEAD}$ verified to be correctly derived.
    - This is the epoch nonce entropy contribution. See [Cryptarchia Protocol - Epoch Nonce](../raw/cryptarchia-v1-protocol.md#epoch-nonce).
