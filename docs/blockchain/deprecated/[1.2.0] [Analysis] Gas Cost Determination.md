# [1.2.0] [Analysis] Gas Cost Determination

| Field | Value |
| --- | --- |
| Name | [1.2.0] [Analysis] Gas Cost Determination |
| Slug | 257 |
| Status | deprecated |
| Type | RFC |
...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.2.0] [Analysis] Gas Cost Determination.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
...
In Mantle, each Mantle Transaction contains one Ledger Transaction and one or more Operations. These components consume gas, measured through fixed gas units that reflect their execution or storage impact. Nomos introduces two independent gas markets:
...
and come from our implementation observations as described in [Gas determination from measures](https://nomos-tech.notion.site/Gas-determination-from-measures-2df261aa09df80d3aed5d4a7e4590101?pvs=24#2df261aa09df801b917add3e8a165ddd).  To get these numbers, we based our calculations on the following measures:
...
![Diagram](https://nomos-tech.notion.site/image/attachment%3Af20c18e4-c9a1-4ac3-91e3-298b450954d0%3Aoutput.png?table=block&id=2df261aa-09df-80bb-aed3-d6cb77b255ee&spaceId=8dee56ee-6a26-4946-83e5-607a431da45d&width=1410&userId=&cache=v2&imgBuildSrc=requestProxiedImageUrl)
...
![Diagram](https://nomos-tech.notion.site/image/attachment%3Ac8963101-58e0-4dad-a1f8-365c2384b2d8%3Aoutput.png?table=block&id=2df261aa-09df-806a-8e0f-eddc7c34d4cf&spaceId=8dee56ee-6a26-4946-83e5-607a431da45d&width=1410&userId=&cache=v2&imgBuildSrc=requestProxiedImageUrl)
