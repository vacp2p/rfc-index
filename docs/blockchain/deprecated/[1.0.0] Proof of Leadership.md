...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.0.0] Proof of Leadership.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
- **2026-05-25** — [`9e6fd67`](https://github.com/logos-co/logos-lips/blob/9e6fd6714b1a03a0210ba53059722429d26a3b0c/docs/blockchain/deprecated/cryptarchia-proof-of-leadership.md) — chore(blockchain): clean lint output for deprecated specs (alt text, code lang, tabs)
- **2026-05-25** — [`bb54413`](https://github.com/logos-co/logos-lips/blob/bb54413f81dd7fd10491f32a18c6808603aed0fb/docs/blockchain/deprecated/cryptarchia-proof-of-leadership.md) — chore(blockchain): import deprecated v1.0.0 specs into deprecated/
- **2026-05-25** — [`90fd8fd`](https://github.com/logos-co/logos-lips/blob/90fd8fda8d0307fc4be4a37bad13b9126cc0cb01/docs/blockchain/raw/cryptarchia-proof-of-leadership.md) — fix(blockchain): import active versions for 2 deprecated-source specs
- **2026-05-25** — [`b968d19`](https://github.com/logos-co/logos-lips/blob/b968d195c4e6a32e5f069be479afb35f0c6af59f/docs/blockchain/raw/cryptarchia-proof-of-leadership.md) — fix(blockchain): import recovered specs from fresh MHTML exports
- **2026-05-25** — [`312928c`](https://github.com/logos-co/logos-lips/blob/312928c26c2560c7805bf097640de36443f32776/docs/blockchain/raw/cryptarchia-proof-of-leadership.md) — fix(blockchain): correct content-swapped specs, fill missing renderers, drop unrecoverable PR #2B targets
- **2026-05-25** — [`cdacf35`](https://github.com/logos-co/logos-lips/blob/cdacf3574287690650c2719b66927b51f5916156/docs/blockchain/raw/cryptarchia-proof-of-leadership.md) — fix(blockchain): drop Notion chrome residue in 17 sync'd specs
- **2026-05-25** — [`7bf533d`](https://github.com/logos-co/logos-lips/blob/7bf533d211617763194453c0276c336b0b53a70e/docs/blockchain/raw/cryptarchia-proof-of-leadership.md) — fix(blockchain): rewrite 17 sync'd spec bodies with DOM-aware converter
- **2026-05-22** — [`6dd2503`](https://github.com/logos-co/logos-lips/blob/6dd2503bbb151775e701e0c73c04366a3842ce9a/docs/blockchain/raw/cryptarchia-proof-of-leadership.md) — chore(blockchain): sync 17 spec bodies from Notion source of truth (PR #2B)
