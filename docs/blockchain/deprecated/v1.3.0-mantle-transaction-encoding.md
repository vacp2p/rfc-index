...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/v1.3.0-mantle-transaction-encoding.md) — chore: move blockchain specs from notion to github
...
| 1.1.0 | Added [\[RFC\] Make Ledger Transaction an Operation](../raw/mantle-transaction-encoding/appendices/rfc-make-ledger-transaction-an-operation.md) |
| 1.2.0 | Added [\[RFC\] Add Deposit/Withdraw to Tx Encoding](../raw/mantle-transaction-encoding/appendices/rfc-add-deposit-withdraw-to-tx-encoding.md) |
| 1.3.0 | Added [\[RFC\] Enforce NoteId uniqueness](../raw/mantle-transaction-encoding/appendices/rfc-enforce-noteid-uniqueness.md) |

# Introduction

This document specifies the canonical encoding of Mantle transactions (see [\[1.4.0\] Mantle - Mantle Transaction](v1.4.0-mantle.md#mantle-transaction)) and its sub-components. Transactions sent through the mempool and included in blocks use this encoding.
