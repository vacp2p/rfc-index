...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.1.0] Mantle.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
...
1. The ledger transaction is valid according to [Ledger Validation](https://nomos-tech.notion.site/Ledger-Validation-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df80fb8c2fcb1d501fed1e).
    ```text
...
1. Execute the Ledger Transaction as described in [Ledger Execution](https://nomos-tech.notion.site/Ledger-Execution-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df8099a758cad305af6354).
...
Locked notes are introduced in [Locked notes](https://nomos-tech.notion.site/Locked-notes-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df80229448ca0de3cb125c) and serve as Service collaterals. They cannot be spent before the owner withdraw its participation from the declared service(s).
...
see: [Zero Knowledge Signature Scheme (ZkSignature)](https://nomos-tech.notion.site/Zero-Knowledge-Signature-Scheme-ZkSignature-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df802d9237e490e910be30).
...
A signature from the zk_id and the locked note pk attached to the declaration is required for withdrawing from a service, (see [Zero Knowledge Signature Scheme (ZkSignature)](https://nomos-tech.notion.site/Zero-Knowledge-Signature-Scheme-ZkSignature-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df802d9237e490e910be30)).
...
The provider proves that they have won a proof of Leadership before the start of the current epoch, i.e., their reward voucher is indeed in the voucher set: [Proof of Claim](https://nomos-tech.notion.site/Proof-of-Claim-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df80a5a1fdfeee3cb0b568).
...
Transactions must prove the ownership of spent notes. In classical blockchains, this is done through a signature. To stay compatible with our architecture, the signature is done by a ZK proof (see [Zero Knowledge Signature Scheme (ZkSignature)](https://nomos-tech.notion.site/Zero-Knowledge-Signature-Scheme-ZkSignature-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df802d9237e490e910be30)), proving the knowledge of the secret key associated with the public key.
...
A transaction proves the ownership of the consumed notes using a [Zero Knowledge Signature Scheme (ZkSignature)](https://nomos-tech.notion.site/Zero-Knowledge-Signature-Scheme-ZkSignature-269261aa09df80dda501f568697930fd?pvs=24#269261aa09df802d9237e490e910be30)
...
![Diagram](https://nomos-tech.notion.site/image/attachment%3Aad1135c7-6705-47d4-8d11-c7322f1f35f2%3Aoutput.png?table=block&id=2b0261aa-09df-8020-8a08-e0c41c1f7746&spaceId=8dee56ee-6a26-4946-83e5-607a431da45d&width=1410&userId=&cache=v2&imgBuildSrc=requestProxiedImageUrl)
...
![Diagram](https://nomos-tech.notion.site/image/attachment%3A6c2a8e67-803d-4a49-8cee-931191d015f8%3Aoutput.png?table=block&id=2b0261aa-09df-80c3-9e5f-d55817c7e45a&spaceId=8dee56ee-6a26-4946-83e5-607a431da45d&width=1410&userId=&cache=v2&imgBuildSrc=requestProxiedImageUrl)
