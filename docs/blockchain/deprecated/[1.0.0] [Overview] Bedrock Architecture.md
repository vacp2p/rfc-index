# [1.0.0] [Overview] Bedrock Architecture

| Field | Value |
| --- | --- |
| Name | [1.0.0] [Overview] Bedrock Architecture |
| Slug | 245 |
| Status | deprecated |
| Type | RFC |
...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.0.0] [Overview] Bedrock Architecture.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
- **2026-05-25** — [`9e6fd67`](https://github.com/logos-co/logos-lips/blob/9e6fd6714b1a03a0210ba53059722429d26a3b0c/docs/blockchain/deprecated/bedrock-architecture-overview.md) — chore(blockchain): clean lint output for deprecated specs (alt text, code lang, tabs)
- **2026-05-25** — [`bb54413`](https://github.com/logos-co/logos-lips/blob/bb54413f81dd7fd10491f32a18c6808603aed0fb/docs/blockchain/deprecated/bedrock-architecture-overview.md) — chore(blockchain): import deprecated v1.0.0 specs into deprecated/
