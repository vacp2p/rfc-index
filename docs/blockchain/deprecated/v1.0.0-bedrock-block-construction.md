...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/v1.0.0-bedrock-block-construction.md) — chore: move blockchain specs from notion to github
...
- header is the header of the proposal; defined below: [Header](v1.0.0-bedrock-block-construction.md#header).
...
- proof_of_leadership is the proof confirming that the sender is the leader; defined below: [Proof of Leadership](v1.0.0-bedrock-block-construction.md#proof-of-leadership).
...
Only after the PoL is generated can the block proposal be constructed (see [\[1.0.0\] Proof of Leadership](v1.0.0-cryptarchia-proof-of-leadership.md)).
...
1. Assemble the block proposal.
    ...
    ```
    The PoL must have been generated beforehand and bound to the same Ledger view as mentioned in the [Prerequisites](v1.0.0-bedrock-block-construction.md#prerequisites).
...
1. Mempool Transactions Validation
    mempool_transactions must refer to a valid sequence of Mantle Transactions from the mempool. Each transaction must be valid according to the rules defined in the [\[1.0.0\] Mantle](v1.0.0-mantle.md).
