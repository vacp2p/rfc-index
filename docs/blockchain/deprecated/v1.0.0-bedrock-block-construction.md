...
Only after the PoL is generated can the block proposal be constructed (see [Proof of Leadership](v1.0.0-cryptarchia-proof-of-leadership.md)).
...
1. Mempool Transactions Validation
    mempool_transactions must refer to a valid sequence of Mantle Transactions from the mempool. Each transaction must be valid according to the rules defined in the [Mantle](v1.0.0-mantle.md).
