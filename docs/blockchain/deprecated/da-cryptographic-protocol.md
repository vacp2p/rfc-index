...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/da-cryptographic-protocol.md) — chore: move blockchain specs from notion to github
- **2026-05-18** — [`58b5698`](https://github.com/logos-co/logos-lips/blob/58b56988429f4d69a9e10a9fc118725e229e37c5/docs/blockchain/deprecated/da-cryptographic-protocol.md) — chore(blockchain): migrate contributor emails to @logos.co (#338)
- **2026-01-30** — [`0ef87b1`](https://github.com/logos-co/logos-lips/blob/0ef87b1ba9491c854e48c8dfd7574d34ec69c704/docs/blockchain/deprecated/da-cryptographic-protocol.md) — New RFC: CODEX-MANIFEST (#191)
- **2026-01-30** — [`25ebb3a`](https://github.com/logos-co/logos-lips/blob/25ebb3ac05e44da058c15db438fa371f10f57003/docs/blockchain/deprecated/da-cryptographic-protocol.md) — Replace nomosda-encoding with da-cryptographic-protocol (#264)

<!-- timeline:end -->

## Abstract

This document describes the cryptographic protocol underlying DA Network,
the data availability (DA) layer for the Logos Blockchain.
DA Network ensures that all blob data submitted is made available and verifiable
...
**Keywords:** DA Network, data availability, KZG, polynomial commitment,
...
DA Network uses a random linear combination of all row polynomials
...
In the DA Network protocol, encoders perform the encoding process
...
The current design of DA Network uses an expansion factor of 2,
...
In DA Network, univariate interpolation is used,
...
- [DA Cryptographic Protocol][origin-ref] - Original specification document
