# [1.0.0] Block Construction, Validation and Execution

| Field | Value |
| --- | --- |
| Name | [1.0.0] Block Construction, Validation and Execution |
| Slug | 238 |
| Status | deprecated |
| Type | RFC |
...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.0.0] Block Construction, Validation and Execution.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
...
- header is the header of the proposal; defined below: [Header](https://nomos-tech.notion.site/Header-215261aa09df8164b5a9f0783c0e99b9?pvs=24#215261aa09df814a99c9c52e5af5f393).
...
- proof_of_leadership is the proof confirming that the sender is the leader; defined below: [Proof of Leadership](https://nomos-tech.notion.site/Proof-of-Leadership-215261aa09df8164b5a9f0783c0e99b9?pvs=24#215261aa09df8162a641f53e06ed3236).
...
Only after the PoL is generated can the block proposal be constructed (see [[1.0.0] Proof of Leadership](https://nomos-tech.notion.site/1-0-0-Proof-of-Leadership-21c261aa09df819ba5b6d95d0fe3066d?pvs=24)).
...
1. Derive references values:
    ...
    ```
1. Compute the header.block_root as the root of the Merkle tree using Blake2b (of arbitrary depth) constructed from the list(service_reward) + mempool_transactions transactions used to build references.
...
1. Assemble the block proposal.
    ...
    ```
    The PoL must have been generated beforehand and bound to the same Ledger view as mentioned in the [Prerequisites](https://nomos-tech.notion.site/Prerequisites-215261aa09df8164b5a9f0783c0e99b9?pvs=24#215261aa09df814088c2e00d2439445c).
...
1. Mempool Transactions Validation
    mempool_transactions must refer to a valid sequence of Mantle Transactions from the mempool. Each transaction must be valid according to the rules defined in the [[1.0.0] Mantle](https://nomos-tech.notion.site/1-0-0-Mantle-21c261aa09df810c8820fab1d78b53d9?pvs=24).
