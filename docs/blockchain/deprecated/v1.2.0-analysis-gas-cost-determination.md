...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/v1.2.0-analysis-gas-cost-determination.md) — chore: move blockchain specs from notion to github
...
and come from our implementation observations as described in [Gas determination from measures](v1.2.0-analysis-gas-cost-determination.md#gas-determination-from-measures).  To get these numbers, we based our calculations on the following measures:
...
![Diagram](v1.2.0-analysis-gas-cost-determination/assets/2df261aa-09df-80bb-aed3-d6cb77b255ee.png)
...
![Diagram](v1.2.0-analysis-gas-cost-determination/assets/2df261aa-09df-806a-8e0f-eddc7c34d4cf.png)
