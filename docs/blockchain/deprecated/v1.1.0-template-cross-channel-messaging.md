...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/v1.1.0-template-cross-channel-messaging.md) — chore: move blockchain specs from notion to github
...
| --- | --- |
| v1 | Initial version. |
| v1.1 |  Added [\[RFC\] Enforce NoteId uniqueness](../raw/mantle-transaction-encoding/appendices/rfc-enforce-noteid-uniqueness.md). |
...
## Reference: [\[1.4.0\] Mantle](v1.4.0-mantle.md).
