# [1.1.0][Template] Cross-Channel Messaging

| Field | Value |
| --- | --- |
| Name | [1.1.0][Template] Cross-Channel Messaging |
| Slug | 254 |
| Status | deprecated |
| Type | RFC |
...
- **2026-05-26** — [`52fe381`](https://github.com/logos-co/logos-lips/blob/52fe381c0a6cea3f7a5b075615409d90320e2543/docs/blockchain/deprecated/[1.1.0][Template] Cross-Channel Messaging.md) — chore(blockchain): import 25 deprecated specs, rename 2 existing to [X.Y.Z] Title convention
- **2026-05-25** — [`312928c`](https://github.com/logos-co/logos-lips/blob/312928c26c2560c7805bf097640de36443f32776/docs/blockchain/raw/template-cross-channel-messaging.md) — fix(blockchain): correct content-swapped specs, fill missing renderers, drop unrecoverable PR #2B targets
- **2026-05-25** — [`d3d87d6`](https://github.com/logos-co/logos-lips/blob/d3d87d669f347de5e82629c096cbfa3d74785400/docs/blockchain/raw/template-cross-channel-messaging.md) — fix(blockchain): drop Notion chrome residue and resolve slug collision
- **2026-05-25** — [`adb554e`](https://github.com/logos-co/logos-lips/blob/adb554ec89b361f5be9cd77119ba571e28f82083/docs/blockchain/raw/template-cross-channel-messaging.md) — fix(blockchain): rewrite Notion-only spec bodies with DOM-aware converter
...
| --- | --- |
| v1 | Initial version. |
| v1.1 |  Added [[RFC] Enforce NoteId uniqueness](https://nomos-tech.notion.site/RFC-Enforce-NoteId-uniqueness-335261aa09df807b9fe3c9bb9bd2c6db?pvs=24). |
...
## Reference: [[1.4.0] Mantle](https://nomos-tech.notion.site/1-4-0-Mantle-335261aa09df8065a38acff4b25aee82?pvs=24).
...
1. The message is included in a Mantle Transaction (through an [Inscription](https://nomos-tech.notion.site/2ce261aa09df805ea358d80c2046cf95)[ Operation](https://nomos-tech.notion.site/2ce261aa09df805ea358d80c2046cf95)):
