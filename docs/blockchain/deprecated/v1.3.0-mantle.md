...
- **2026-05-27** — [`b7602ed`](https://github.com/logos-co/logos-lips/blob/b7602ed8a225d41ca0bfaaa432524dc84d2ded7e/docs/blockchain/deprecated/v1.3.0-mantle.md) — chore: move blockchain specs from notion to github
...
| 1.3.0 |  added [\[RFC\] Make Ledger Transaction an Operation](../raw/mantle-transaction-encoding/appendices/rfc-make-ledger-transaction-an-operation.md) | 2026-04-02 |
...
Channel Inscribe Operations have a fixed Execution Gas cost of EXECUTION_CHANNEL_INSCRIBE_GAS. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
Channel Config Operations have a linear Execution Gas cost equal to EXECUTION_CHANNEL_CONFIG_GAS * configuration_threshold. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
Channel Deposit Operations have a fixed Execution Gas cost of EXECUTION_CHANNEL_DEPOSIT_GAS. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
Channel Withdraw Operations have a linear Execution Gas cost equal to EXECUTION_CHANNEL_WITHDRAW_GAS * withdraw_threshold. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
Locked notes are introduced in [Locked notes](v1.3.0-mantle.md#locked-notes) and serve as Service collaterals. They cannot be spent before the owner withdraw its participation from the declared service(s).
...
see: [Zero Knowledge Signature Scheme (ZkSignature)](v1.3.0-mantle.md#zero-knowledge-signature-scheme-zksignature).

Execution Gas

SDP Declare Operations have a fixed Execution Gas cost of EXECUTION_SDP_DECLARE_GAS. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
A signature from the zk_id and the locked note pk attached to the declaration is required for withdrawing from a service, (see [Zero Knowledge Signature Scheme (ZkSignature)](v1.3.0-mantle.md#zero-knowledge-signature-scheme-zksignature)).
...
SDP Withdraw Operations have a fixed Execution Gas cost of EXECUTION_SDP_WITHDRAW_GAS. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
SDP Active Operations have a fixed Execution Gas cost of EXECUTION_SDP_ACTIVE_GAS. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
The provider proves that they have won a proof of Leadership before the start of the current epoch, i.e., their reward voucher is indeed in the voucher set: [Proof of Claim](v1.3.0-mantle.md#proof-of-claim).

Execution gas

Leader Claim Operations have a fixed Execution Gas cost of EXECUTION_LEADER_CLAIM_GAS. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
A Transfer proves the ownership of the consumed notes using a [Zero Knowledge Signature Scheme (ZkSignature)](v1.3.0-mantle.md#zero-knowledge-signature-scheme-zksignature).
...
Transfer have a fixed Execution Gas cost of EXECUTION_TRANSFER_GAS. See [Gas Determination](v1.3.0-mantle.md#gas-determination) for the Execution Gas values.
...
From the [\[Analysis\] Gas Cost Determination](v1.3.0-analysis-gas-cost-determination.md), we get the table below:
...
![Diagram](v1.3.0-mantle/assets/330261aa-09df-8193-8727-da05d80887a0.png)
...
![Diagram](v1.3.0-mantle/assets/330261aa-09df-818f-8a38-e29d46cc405b.png)
