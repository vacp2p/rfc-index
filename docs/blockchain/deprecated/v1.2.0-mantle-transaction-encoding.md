...
This document specifies the canonical encoding of Mantle transactions (see [Mantle - Mantle Transaction](v1.3.0-mantle.md#mantle-transaction)) and its sub-components. Transactions sent through the mempool and included in blocks use this encoding.
