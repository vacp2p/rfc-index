...
- **2026-05-22** — [`e8cedab`](https://github.com/logos-co/logos-lips/blob/e8cedab986dd17a9ff7bc718398b7162c2ab0d89/docs/blockchain/raw/analysis-block-rewards.md) — fix(blockchain): re-import 25 Notion-only spec bodies with proper markdown formatting
- **2026-05-22** — [`4c38737`](https://github.com/logos-co/logos-lips/blob/4c38737840346f1d3ba899ecab61c255e5c88f93/docs/blockchain/raw/analysis-block-rewards.md) — chore(blockchain): import 25 Notion-only specs as scaffold files (PR #2A)
...
According to the Equation [(1)](https://nomos-tech.notion.site/d96261aa09df838ca36601b4b27b49b4?pvs=25#820261aa09df83949c400177c46b2514) and KPIs definitions, $\alpha_d$ controls the responsiveness of the emission rate to the deviation with respect to a target inferred total stake, while $\alpha_a$ converts from annualized burn rate to annualized token emission rates.
