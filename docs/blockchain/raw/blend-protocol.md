...
| 1.2.1 | Recomputed the encapsulation overhead for the revised compression: `Max_Payload_Length` = 10003 bytes, overhead ≈ 11.2% (see [Block Construction, Validation and Execution](bedrock-v1.1-block-construction.md)). | 2026-08-20 |
