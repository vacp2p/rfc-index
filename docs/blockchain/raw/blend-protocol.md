...
| 1.1.1 | Updated the block proposal message size to 33257 bytes in the encapsulation-overhead calculation, following the addition of the `uncles` field in [Block Construction, Validation and Execution](bedrock-v1.1-block-construction.md). | 2026-07-09 |
