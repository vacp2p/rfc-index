...
$$
\mathsf{nonce}_{0} = \mathsf{SHA256}(\mathsf{account\_id} \;||\; [0_{u8}; 32])_{[0..16]}
$$
...
$$
\mathsf{ViewTag} = \operatorname{first\_byte}\!\left(\mathsf{SHA256}(\text{"/LEE/v0.3/ViewTag/"} \;||\; \mathsf{Npk} \;||\; \mathsf{vpk})\right)
$$
