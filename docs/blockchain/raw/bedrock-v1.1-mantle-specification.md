...
The genesis reward pool is given as a fraction of the launch supply in [Genesis](#genesis), so that it is independent of the unit in which the pool is counted.
