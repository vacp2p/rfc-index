...
It is stated as a fraction of the maximum supply rather than as a count of lepta because that is the form in which it is a decision about how the initial supply is divided, which is what it is. The opening reward per claim follows from the fraction, $`\rho`$ and the target claim rate alone.
