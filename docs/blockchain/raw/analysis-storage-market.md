...
Since $`C'(P^*) \lt 0`$ (demand falls with price) and $`(1 - (1-w)\beta) \gt 0`$ for reasonable parameter choices, the right-hand inequality is always satisfied. The left-hand inequality defines the stability condition:
