...
See [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/19/lightpush.md) for the definitions of `PushRequest` and `PushResponse`.
...
- [12/WAKU2-FILTER](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/12/filter.md)
