...
For example, Waku Relay typically propagates messages up to **150 KB** as per [64/WAKU2-NETWORK - Message](../../draft/core/64/network.md#message-size).
...
- Consider rate-limiting at the transport layer (for example, via [17/WAKU2-RLN-RELAY](../../draft/core/17/rln-relay.md) on Waku)
...
1. [10/WAKU2 – Waku](../../draft/core/10/waku2.md)
2. [11/WAKU2-RELAY – Relay](../../stable/core/11/relay.md)
3. [14/WAKU2-MESSAGE – Message](../../stable/core/14/message.md)
4. [64/WAKU2-NETWORK](../../draft/core/64/network.md#message-size)
