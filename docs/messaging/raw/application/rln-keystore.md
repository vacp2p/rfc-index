...
A [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md)
...
A format example of a keystore used by a [17/WAKU2-RLN-Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md).
...
2. [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md)
