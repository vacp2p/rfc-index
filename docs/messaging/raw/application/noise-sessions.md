...
network peers MAY discard all [stored](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/13/store.md) messages addressed to the content topic `/{application-name}/{application-version}/wakunoise/1/sessions/{ct-id}/proto`.
