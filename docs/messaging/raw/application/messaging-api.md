...
types:
  ...
  ProtocolsConfig:
    ...
    fields:
      ...
      cluster_id:
        type: uint
        description: "The cluster ID for the network. Cluster IDs are defined in [RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md) and allocated in [RELAY-STATIC-SHARD-ALLOC](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/informational/relay-static-shard-alloc.md)."
...
- [RENDEZVOUS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/rendezvous.md) as client and service node
...
See [WAKU2-ADVERSARIAL-MODELS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/informational/adversarial-models.md).
