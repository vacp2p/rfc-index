...
by exchanging messages over the content topic with the following [format](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/informational/23/topics.md#content-topic-format)
...
2. The device `A`:
   ...
   - executes the first handshake message over `contentTopic`, i.e.
     - processes and sends a [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/14/message.md) containing an ephemeral key `eA`;
...
6. The device `A`:
   ...
   - listens to messages sent to `contentTopic` and locally filters only those with [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/application/26/payload.md) starting with `messageNametag`.
     If any, continues.
...
7. The device `B`:
   ...
   - listens to messages sent to `contentTopic` and locally filters only those with [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/application/26/payload.md) starting with `messageNametag`. If any, continues.
...
the `mntsInbound` and `mntsOutbound` secrets can be used to iteratively generate the `messageNametag` field of [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/application/26/payload.md)s
...
- [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/application/26/payload.md#abnf)
- [format](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/informational/23/topics.md#content-topic-format)
