...
This document describes ways of sharding the [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/11/relay.md) topic,
...
With this, the number of [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/11/relay.md) content topics that can be carried over a pubsub topic is limited.
...
It is RECOMMENDED for App protocols to follow the naming structure detailed in [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/23/topics.md).
...
Since the introduction of [the Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/64/network.md),
...
> _Note_: Because _all_ shards distribute payload defined in [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/14/message.md) via [protocol buffers](https://developers.google.com/protocol-buffers/),
...
An example is [the Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/64/network.md).
To use autosharding,
...
Content topics MUST follow the format in [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/23/topics.md#content-topic-format).
...
We currently use [33/WAKU2-DISCV5](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/33/discv5.md) for discovery,
