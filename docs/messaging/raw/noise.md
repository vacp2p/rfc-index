...
This specification extends the functionalities provided by [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/26/payload.md),
...
It is possible to have backward compatibility to symmetric/asymmetric encryption primitives from [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/26/payload.md),
...
and set the `transport-message` field to the [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/26/payload.md) `data` field, whenever these `protocol-id` values are set.
...
- `transport-message`: contains the [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/26/payload.md) `data` field (AES-256-GCM or ECIES, depending on `protocol-id`);
- `transport-message-len` is set accordingly to `transport-message` length;

When a `transport-message` corresponding to `protocol-id = 254, 255` is retrieved,
it SHOULD be decoded as the `data` field in [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/26/payload.md) specification.
...
2. [10/WAKU2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/10/waku2.md)
3. [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/26/payload.md)
