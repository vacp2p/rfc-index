...
The only defined capability for now is `mix`, representing [Waku Mix](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/mix.md) support.
...
Refer to [RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md) for cluster information.
