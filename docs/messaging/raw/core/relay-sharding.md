...
This document describes ways of sharding the [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/11/relay.md) topic,
...
With this, the number of [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/11/relay.md) content topics that can be carried over a pubsub topic is limited.
...
It is RECOMMENDED for App protocols to follow the naming structure detailed in [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/informational/23/topics.md).
...
Since the introduction of [the Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/64/network.md),
...
> _Note_: Because _all_ shards distribute payload defined in [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/14/message.md) via [protocol buffers](https://developers.google.com/protocol-buffers/),
...
Nodes add information about their shard participation in their [WAKU2-ENR](../../draft/core/31/enr.md).
Having a static shard participation indication as part of the ENR allows nodes
to discover peers that are part of shards via [33/WAKU2-DISCV5](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/33/discv5.md) as well as via DNS.
...
> We will update [WAKU2-ENR](../../draft/core/31/enr.md) accordingly, once this RFC moves forward.
...
An example is [the Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/64/network.md).
To use autosharding,
...
Content topics MUST follow the format in [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/informational/23/topics.md#content-topic-format).
...
We currently use [33/WAKU2-DISCV5](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/33/discv5.md) for discovery,
...
- [11/WAKU2-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/11/relay.md)
- [Unstructured P2P network](https://en.wikipedia.org/wiki/Peer-to-peer#Unstructured_networks)
- [33/WAKU2-DISCV5](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/33/discv5.md)
- [WAKU2-ENR](../../draft/core/31/enr.md)
- [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/informational/23/topics.md)
...
- [64/WAKU2-NETWORK](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/64/network.md)
