...
For the full specification of RLN Relay, see [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md).
...
Note: epoch length means the same as `period` as defined in [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md).
