...
The only defined capability for now is `mix`, representing [Waku Mix](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/mix.md) support.
...
Refer to [RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md) for cluster information.
