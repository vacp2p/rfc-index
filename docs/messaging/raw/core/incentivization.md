...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/raw/incentivization.md) — chore: split ift ts specs (#334)
- **2026-05-07** — [`48600b5`](https://github.com/logos-co/logos-lips/blob/48600b5b4fcdcb89f3d556ee0e4d417526f2919a/docs/messaging/standards/core/incentivization.md) — Migrate logos-messaging/specs into docs/messaging/ (#315)
...
See [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/19/lightpush.md) for the definitions of `PushRequest` and `PushResponse`.
...
- [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/19/lightpush.md) (for Lightpush-specific sections)

### informative

RFCs of request-response protocols:

- [12/WAKU2-FILTER](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/12/filter.md)
...
- [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md)
