...
This document lists static shard flag index assignments (see [WAKU2-RELAY-SHARDING](../core/relay-sharding.md)).
...
this document lists static shard index assignments (see [WAKU2-RELAY-SHARDING](../core/relay-sharding.md).
...
| ----- | ------------ | --------------------------------------------------------------- |
| 0     | global       | global use                                                      |
| 1     | reserved     | [The Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/64/network.md) |
| 2     | reserved     |                                                                 |
| 3     | reserved     |                                                                 |
| 4     | reserved     |                                                                 |
| 5     | reserved     |                                                                 |
...
- [The Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/64/network.md)
