...
Future versions of this document will serve as a comprehensive list of adversarial models and attack based threats relevant for [Waku v2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/10/waku2.md).
...
Because each [Waku message](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/14/message.md) is associated with a content topic, and each receiver is interested in messages with specific content topics,
...
Waku protocols are protected by a secure channel set up with [Noise](../application/noise.md).
...
The following lists various attacks against [Waku v2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/10/waku2.md) protocols.
If not specifically mentioned, the attacks refer to [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/11/relay.md) and the underlying [libp2p GossipSub](https://github.com/libp2p/specs/blob/master/pubsub/gossipsub/README.md).
...
For [Waku Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/11/relay.md) this means we only consider messages with version field `2`,
which indicates that the payload has to be encoded using [Noise](../application/noise.md).

Note: The currently listed attacks are against libp2p in general.
The [data field of Waku v2 relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/11/relay.md#message-fields) must be a [Waku v2 message](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/14/message.md).
...
Further, replay attacks will be punished by [RLN Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md).
...
Waku employs [RLN Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md) as the main countermeasure to flooding.
[SWAP](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/deprecated/application/18/swap.md) also helps mitigating DoS attacks.
...
such as [Waku Dandelion](../application/dandelion.md).
[Waku Dandelion](../application/dandelion.md)) also discusses mitigation techniques compensating the amplified black hole potential.)
...
- [Waku v2 message](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/stable/core/14/message.md)
...
- [Noise](../application/noise.md)
- [17/WAKU-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/17/rln-relay.md)
- [18/WAKU2-SWAP](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/deprecated/application/18/swap.md)
...
- [Waku Dandelion](../application/dandelion.md))
