...
unless the envelopes are sent as a [mailserver](../../../stable/application/8/mail.md) response.
...
e.g. Waku Mail Client requesting old messages from the [Waku Mail Server](../../../stable/application/8/mail.md).
...
which is documented in its on [specification](../../../stable/application/8/mail.md).
...
The security considerations for extra capabilities such as [mailservers](../../../stable/application/8/mail.md#security-considerations)
