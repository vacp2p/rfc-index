...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/deleted/fault-tolerant-store.md) — chore: split ift ts specs (#334)
...
<!-- timeline:end -->
 ...
 The reliability of [13/WAKU2-STORE](../../core/draft/13/store.md)
...
## Method description
 ...
 As the first step
towards making the [13/WAKU2-STORE](../../core/draft/13/store.md) protocol fault-tolerant,
...
We extend the [HistoryQuery](../../core/draft/13/store.md#payloads) protobuf message
...
[`HistoryResponse`](../../core/draft/13/store.md#store-query-response)
MUST contain historical waku messages whose
[`timestamp`](../../core/stable/14/message.md#message-attributes)
...
[`HistoryResponse`](../../core/draft/13/store.md#store-query-response)
MUST contain historical waku messages whose
[`timestamp`](../../core/stable/14/message.md#message-attributes) is less than or equal to the `end_time`.
...
- [13/WAKU2-STORE](../../core/draft/13/store.md)
- [`timestamp`](../../core/stable/14/message.md#message-attributes)
