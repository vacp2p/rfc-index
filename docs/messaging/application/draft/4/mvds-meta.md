...
will aid the consistency guarantees of [2/MVDS](../../../core/stable/2/mvds.md).
Additionally,
...
Nodes MAY transmit a `Metadata` message by extending the MVDS [message](../../../core/stable/2/mvds.md#payloads)
...
| Name                   |   Description                                                                                                                    |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `parents`               |   list of parent [`message identifier`s](../../../core/stable/2/mvds.md#payloads) for the specific message. |
...
This field contains a list of parent [`message identifier`s](../../../core/stable/2/mvds.md#payloads)
...
1: [2/MVDS](../../../core/stable/2/mvds.md)
