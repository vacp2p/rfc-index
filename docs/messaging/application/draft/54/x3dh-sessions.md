...
[53/WAKU2-X3DH](/messaging/application/draft/53/x3dh.md) specifies the Waku `X3DH` protocol
...
1. Inherits all security considerations from [53/WAKU2-X3DH](/messaging/application/draft/53/x3dh.md).
...
- [53/WAKU2-X3DH](/messaging/application/draft/53/x3dh.md)
