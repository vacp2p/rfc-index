...
signing works in [6/WAKU1](../../../core/stable/6/waku1.md) and
in [10/WAKU2](../../../core/draft/10/waku2.md) with [14/WAKU-MESSAGE](../../../core/stable/14/message.md#payload-encryption).

This specification effectively replaces [7/WAKU-DATA](../../stable/7/data.md)
as well as [6/WAKU1 Payload encryption](../../../core/stable/6/waku1.md#payload-encryption)
but written in a way that is agnostic and self-contained for [6/WAKU1](../../../core/stable/6/waku1.md) and [10/WAKU2](../../../core/draft/10/waku2.md).
...
For [6/WAKU1](../../../core/stable/6/waku1.md),
the `data` field is used in the [waku envelope](../../../core/stable/6/waku1.md#abnf-specification)
and the field MAY contain the encrypted payload.

For [10/WAKU2](../../../core/draft/10/waku2.md),
...
1. [6/WAKU1](../../../core/stable/6/waku1.md)
2. [10/WAKU2 spec](../../../core/draft/10/waku2.md)
3. [14/WAKU-MESSAGE version 1](../../../core/stable/14/message.md#payload-encryption)
