...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/raw/rln-keystore.md) — chore: split ift ts specs (#334)
- **2026-05-07** — [`48600b5`](https://github.com/logos-co/logos-lips/blob/48600b5b4fcdcb89f3d556ee0e4d417526f2919a/docs/messaging/standards/application/rln-keystore.md) — Migrate logos-messaging/specs into docs/messaging/ (#315)
...
A [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/17/rln-relay.md)
keystore stores a node's credentials locally and
[32/RLN-V1](https://github.com/logos-co/logos-lips/blob/master/docs/anoncomms/draft/32/rln-v1.md) is used as a spam-prevention mechanism with the help of zero-knowledge proofs.
...
With [32/RLN-V1](https://github.com/logos-co/logos-lips/blob/master/docs/anoncomms/draft/32/rln-v1.md), sending and receiving 
...
A format example of a keystore used by a [17/WAKU2-RLN-Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/17/rln-relay.md).
...
2. [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/17/rln-relay.md)
