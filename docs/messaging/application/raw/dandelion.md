...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/raw/dandelion.md) — chore: split ift ts specs (#334)
- **2026-05-07** — [`48600b5`](https://github.com/logos-co/logos-lips/blob/48600b5b4fcdcb89f3d556ee0e4d417526f2919a/docs/messaging/standards/application/dandelion.md) — Migrate logos-messaging/specs into docs/messaging/ (#315)
...
for Waku Relay.
It mitigates mass deanonymization in the [multi-node (botnet) attacker model](../../informational/raw/adversarial-models.md#multi-node),
...
[Waku Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md), offers privacy, pseudonymity, and a first layer of anonymity protection by design.
Being a modular protocol family [Waku v2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/10/waku2.md)
...
Libp2p gossipsub aims at spanning a [d-regular graph](https://en.wikipedia.org/wiki/Regular_graph) topology, with d=6 as the [default value](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/draft/29/config.md#gossipsub-v10-parameters).
...
WAKU2-DANDELION can be seen as an anonymity enhancing add-on to [Waku Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md) message dissemination,
...
The fluff phase corresponds to [Waku Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md),
...
WAKU2-DANDELION uses [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) as the protocol for relaying stem messages.
...
Stem relays MUST support [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md).
If a chosen peer does not support [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md),
...
of peers the node receives [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) messages from.
Incoming [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) connections from peers that do not support WAKU2-DANDELION are identified and mapped in the same way.
...
The stem protocol ([19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md)) is independent of the fluff protocol ([Waku Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md)).
...
Handling of the WAKU2-DANDELION stem phase can be implemented as an extension to an existing [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) implementation.
...
In a [black hole attack](../../informational/raw/adversarial-models.md#black-hole-internal), malicious nodes prevent messages from being spread,
...
passive [scaling multi node model](../../informational/raw/adversarial-models.md#scaling-multi-node).
...
and interpret the message as classical [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md),
...
if the random stem relay selection yields at least one peer that does not support [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) (which is the stem protocol used in WAKU2-DANDELION.
If nodes would reselect peers until they find peers supporting [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md),
malicious nodes would get an advantage if a significant number of honest nodes would not support [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md).
...
Still, it is important to note that [Waku2 messages](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md#payloads) (in their current version) carry an originator timestamp,
...
messages sent by nodes that only support [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) might be routed through a Dandelion stem without them knowing.
...
- add a flag to [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md) indicating a message should be routed over a Dandelion stem (opt-in), or
- add a flag to [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md) indicating a message should _not_ be routed over a Dandelion stem (opt-out), or
- introducing a fork of [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) exclusively used for Dandelion stem.
...
- [multi-node (botnet) attacker model](../../informational/raw/adversarial-models.md#multi-node)
- [Waku Relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md)
- [Waku v2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/10/waku2.md)
...
- [Adversarial Models](../../informational/raw/adversarial-models.md)
- [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md)
- [29/WAKU-CONFIG](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/draft/29/config.md)
- [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md)
