...
This document makes use of the shared terminology defined in the [CHAT-DEFINITIONS](../../informational/raw/chatdefs.md) specification.
...
Transport choice is an client/application decision that should be made based on deployment requirements.
...
- [CHAT-DEFINITIONS](../../informational/raw/chatdefs.md) "Chat Definitions Specification", Waku, 2024.
