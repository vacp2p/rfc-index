...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/raw/noise.md) — chore: split ift ts specs (#334)
- **2026-05-07** — [`48600b5`](https://github.com/logos-co/logos-lips/blob/48600b5b4fcdcb89f3d556ee0e4d417526f2919a/docs/messaging/standards/application/noise.md) — Migrate logos-messaging/specs into docs/messaging/ (#315)

<!-- timeline:end -->

This specification describes how payloads of [Waku messages](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/stable/14) with [version 2](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/stable/14) can be encrypted
...
This specification extends the functionalities provided by [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md),
...
Four Noise handshakes are currently supported: `K1K1`, `XK1`, `XX`, `XXpsk0`. Their description can be found in [Appendix: Supported Handshakes Description](#appendix-supported-handshakes-description).
...
In the following, we assume that communicating parties reciprocally know an initial [`contentTopic`](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/stable/14/#wakumessage)
...
When [14/WAKU-MESSAGE version](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/stable/14/#payload-encryption) is set to 2,
...
- `handshake-message`: the Noise handshake message (`handshake-message-len` bytes).
  ...
  encoded as in [Public Keys Encoding](#public-keys-serialization);
...
As regards the underlying supported [cryptographic primitives](#encryption-primitives):
...
It is possible to have backward compatibility to symmetric/asymmetric encryption primitives from [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md),
effectively encapsulating payload encryption [14/WAKU-MESSAGE version 1](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/stable/14/#version1) in [version 2](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/stable/14/#version2).
...
and set the `transport-message` field to the [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md) `data` field, whenever these `protocol-id` values are set.
...
- `transport-message`: contains the [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md) `data` field (AES-256-GCM or ECIES, depending on `protocol-id`);
- `transport-message-len` is set accordingly to `transport-message` length;

When a `transport-message` corresponding to `protocol-id = 254, 255` is retrieved,
it SHOULD be decoded as the `data` field in [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md) specification.
...
2. [10/WAKU2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/10/waku2.md)
3. [26/WAKU-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md)
4. [14/WAKU-MESSAGE](https://github.com/logos-co/logos-lips/tree/master/docs/messaging/stable/14)
