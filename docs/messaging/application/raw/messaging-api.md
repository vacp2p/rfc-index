...
- [RENDEZVOUS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/rendezvous.md) as client and service node
...
See [WAKU2-ADVERSARIAL-MODELS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/raw/adversarial-models.md).
