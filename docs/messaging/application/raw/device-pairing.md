...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/raw/device-pairing.md) — chore: split ift ts specs (#334)
- **2026-05-07** — [`48600b5`](https://github.com/logos-co/logos-lips/blob/48600b5b4fcdcb89f3d556ee0e4d417526f2919a/docs/messaging/standards/application/device-pairing.md) — Migrate logos-messaging/specs into docs/messaging/ (#315)
...
by exchanging messages over the content topic with the following [format](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/draft/23/topics.md#content-topic-format)
...
2. The device `A`:
   ...
   - executes the first handshake message over `contentTopic`, i.e.
     - processes and sends a [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md) containing an ephemeral key `eA`;
...
6. The device `A`:
   ...
   - listens to messages sent to `contentTopic` and locally filters only those with [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md) starting with `messageNametag`.
     If any, continues.
...
7. The device `B`:
   ...
   - listens to messages sent to `contentTopic` and locally filters only those with [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md) starting with `messageNametag`. If any, continues.
...
the `mntsInbound` and `mntsOutbound` secrets can be used to iteratively generate the `messageNametag` field of [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md)s
...
- [26/WAKU2-PAYLOAD](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/draft/26/payload.md#abnf)
- [format](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/draft/23/topics.md#content-topic-format)
