...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/stable/11/relay.md) — chore: split ift ts specs (#334)
- **2026-04-20** — [`c3d15a9`](https://github.com/logos-co/logos-lips/blob/c3d15a9c7c24b4d6b0eb4fb578f9670ede6f69b0/docs/messaging/standards/core/11/relay.md) — COSS overhaul: new statuses, CFR type, raw-spec leniency (#308)
...
`topicId` refering to content-topic are detailed in [23/WAKU2-TOPICS](../../../draft/informational/23/topics.md).
...
it is recommended by [`10/WAKU2`](../../../draft/core/10/waku2.md) to use a single PubSub topic
...
More details on this new technique can be found in [`17/WAKU2-RLN-RELAY`](../../../draft/core/17/rln-relay.md).
...
1. [`10/WAKU2`](../../../draft/core/10/waku2.md)

1. [`14/WAKU2-MESSAGE`](../14/message.md)

1. [`17/WAKU-RLN`](../../../draft/core/17/rln-relay.md)
