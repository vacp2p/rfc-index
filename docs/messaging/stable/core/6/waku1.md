...
unless the envelopes are sent as a [8/WAKU-MAIL](../../application/8/mail.md) response.
...
envelopes from the [Waku Mail Server](../../application/8/mail.md).
...
Additionally,
there is the capability of a mailserver which is documented in its on [specification](../../application/8/mail.md).
...
such as [mailservers](../../application/8/mail.md#security-considerations)
