...
`topicId` refering to content-topic are detailed in [23/WAKU2-TOPICS](../../../informational/draft/23/topics.md).
...
it is recommended by [`10/WAKU2`](../../draft/10/waku2.md) to use a single PubSub topic
...
More details on this new technique can be found in [`17/WAKU2-RLN-RELAY`](../../draft/17/rln-relay.md).
...
1. [`10/WAKU2`](../../draft/10/waku2.md)

1. [`14/WAKU2-MESSAGE`](../14/message.md)

1. [`17/WAKU-RLN`](../../draft/17/rln-relay.md)
