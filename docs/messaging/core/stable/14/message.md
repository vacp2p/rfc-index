...
[10/WAKU2](/messaging/core/draft/10/waku2.md) is a family of modular peer-to-peer protocols
...
At a high level,
[10/WAKU2](/messaging/core/draft/10/waku2.md) implements a publish/subscribe messaging pattern over libp2p and
adds capabilities.

The present document specifies the [10/WAKU2](/messaging/core/draft/10/waku2.md) message format.
A way to encapsulate the messages sent with specific information security goals,
and Whisper/[6/WAKU1](/messaging/core/stable/6/waku1.md) backward compatibility.
...
- One may want to provide compatibility with [6/WAKU1](/messaging/core/stable/6/waku1.md) envelopes.
...
as described in [23/WAKU2-TOPICS](/messaging/informational/draft/23/topics.md).
...
to various [10/WAKU2](/messaging/core/draft/10/waku2.md) protocols,
...
contains a rate limit proof encoded as per [17/WAKU2-RLN-RELAY](/messaging/core/draft/17/rln-relay.md).
...
- **Version 1:**
The payload SHOULD be encrypted using [6/WAKU1](/messaging/core/stable/6/waku1.md) payload encryption specified in [26/WAKU-PAYLOAD](/messaging/application/draft/26/payload.md).
...
- **Version 2:**
The payload SHOULD be encoded according to [WAKU2-NOISE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/raw/noise.md).
...
## Whisper/[6/WAKU1](/messaging/core/stable/6/waku1.md) envelope compatibility

Whisper/[6/WAKU1](/messaging/core/stable/6/waku1.md) envelopes are compatible with Waku messages format.

- Whisper/[6/WAKU1](/messaging/core/stable/6/waku1.md) `topic` field
SHOULD be mapped to Waku message's `content_topic` attribute.
- Whisper/[6/WAKU1](/messaging/core/stable/6/waku1.md) `data` field SHOULD be mapped to Waku message's `payload` attribute.

[10/WAKU2](/messaging/core/draft/10/waku2.md) implements a publish/subscribe messaging pattern over libp2p.
This makes some Whisper/[6/WAKU1](/messaging/core/stable/6/waku1.md) envelope fields redundant
...
a [10/WAKU2](/messaging/core/draft/10/waku2.md) message's hash MUST be computed following this schema:
...
signature schemes supported by [10/WAKU2](/messaging/core/draft/10/waku2.md),
...
Applications using [10/WAKU2](/messaging/core/draft/10/waku2.md) messages’ `timestamp` attribute
...
see [62/STATUS-PAYLOADS](../../../application/draft/26/payload.md).
...
- [23/WAKU2-TOPICS](/messaging/informational/draft/23/topics.md)
- [17/WAKU2-RLN-RELAY](/messaging/core/draft/17/rln-relay.md)
- [64/WAKU2-NETWORK](/messaging/core/draft/64/network.md)
- [protocol buffers v3](https://developers.google.com/protocol-buffers/)
- [26/WAKU-PAYLOAD](/messaging/application/draft/26/payload.md)
- [WAKU2-NOISE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/application/raw/noise.md)
- [62/STATUS-PAYLOADS](../../../application/draft/26/payload.md)
