...
- **2026-04-20** — [`c3d15a9`](https://github.com/logos-co/logos-lips/blob/c3d15a9c7c24b4d6b0eb4fb578f9670ede6f69b0/docs/messaging/deprecated/5/waku0.md) — COSS overhaul: new statuses, CFR type, raw-spec leniency (#308)
...
unless the envelopes are sent as a [mailserver](../../../application/stable/8/mail.md) response.
...
e.g. Waku Mail Client requesting old messages from the [Waku Mail Server](../../../application/stable/8/mail.md).
...
which is documented in its on [specification](../../../application/stable/8/mail.md).
...
The security considerations for extra capabilities such as [mailservers](../../../application/stable/8/mail.md#security-considerations)
