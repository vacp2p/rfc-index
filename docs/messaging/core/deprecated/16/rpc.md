...
Refer to the [Waku v2 specification](../../draft/10/waku2.md)
...
Refer to [`Waku Message` specification](../../stable/14/message.md) for more information.
...
| `ephemeral` | `Boolean` | optional | This flag indicates the transient nature of the message. Indicates if the message is eligible to be stored by the `store` protocol, [13/WAKU2-STORE](../../draft/13/store.md). |
...
Refer to the [Waku Relay specification](../../stable/11/relay.md)
...
This allows backwards compatibility with [Waku v1 nodes](../../stable/6/waku1.md).
...
Refer to the [Waku Store specification](../../draft/13/store.md)
...
| `startTime` | `Number`| optional | The inclusive lower bound on the [`timestamp`](../../stable/14/message.md#message-attributes) of queried [`WakuMessage`s](#wakumessage). This field holds the Unix epoch time in nanoseconds as a 64-bits integer value. |
| `endTime` | `Number` | optional |  The inclusive upper bound on the [`timestamp`](../../stable/14/message.md#message-attributes) of queried [`WakuMessage`s](#wakumessage). This field holds the Unix epoch time in nanoseconds as a 64-bits integer value. |
...
Refer to the [Waku Filter specification](../../draft/12/filter.md)
...
1. [Waku v2 specification](../../draft/10/waku2.md)
