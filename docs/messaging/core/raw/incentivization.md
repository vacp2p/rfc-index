...
See [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) for the definitions of `PushRequest` and `PushResponse`.
...
- [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) (for Lightpush-specific sections)

### informative

RFCs of request-response protocols:

- [12/WAKU2-FILTER](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/12/filter.md)
...
- [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/17/rln-relay.md)
