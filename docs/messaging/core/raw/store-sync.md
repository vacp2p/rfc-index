...
This document describes a strategy to keep [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) nodes synchronised,
using a combination of [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) queries
and the [WAKU-SYNC](sync.md) protocol.

## Background / Rationale / Motivation

Message propagation in [10/WAKU2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/10/waku2.md) networks is not perfect.
Even with [peer-to-peer reliability](../../application/raw/p2p-reliability.md) mechanisms,
...
One such service is the [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) protocol
that allows nodes to cache historical [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md)s from the routing layer,
and provision these to clients.
Using Waku Store Sync,
[13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) can remain synchronised
and reach eventual consistency despite occasional losses on the routing layer.

## Scope:

Waku Store Sync aims to provide a way for [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) nodes
to compare and retrieve differences with other [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) nodes,
...
A [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) node with Store Sync enabled:
...
or at startup,
a Store Sync node using Store Resume SHOULD select another [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) node using any available discovery mechanism.
We RECOMMEND that this to be a random node.
Next, the Store Sync node SHOULD perform a [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md#content-filtered-queries) query
...
1. `reconciliation` MUST be used to detect and exchange differences between [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md)s cached by the [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) node
...
where the [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) node caches messages received via normal routing.
...
For simplicity, a Store Sync node MAY assume that any other [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) peer
...
it could continue attempting to sync with other [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) peers on a trial-and-error basis
...
- [10/WAKU2](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/10/waku2.md)
- [13/WAKU2-STORE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md)
- [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md)
- [WAKU-P2P-RELIABILITY](../../application/raw/p2p-reliability.md)
- [WAKU2-SYNC](sync.md)
