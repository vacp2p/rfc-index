...
previous version: `/vac/waku/lightpush/2.0.0-beta1` [19/WAKU2-LIGHTPUSH](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md)
...
- either relay the encapsulated message via [11/WAKU2-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md) protocol on the specified `pubsub_topic`<br>
...
Depending on the network configuration, the lightpush client may not need to provide `pubsub_topic` ([WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/relay-sharding.md)).<br>
...
- message rate limiting via [17/WAKU2-RLN-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/17/rln-relay.md), applied via network membership subscription.
