...
This document covers integration of mix with [lightpush](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md) and [store](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) protocols.
...
Topic interests of a user can be identified by analyzing [Store](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/13/store.md) query messages sent by a user.
Same applies for topic subscriptions via [Filter](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/12/filter.md) protocol.
...
Anonymity of [Filter](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/12/filter.md) users is not addressed by this document.
...
The serialized [Waku Message](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md) MUST be the payload in the [sphinx packet](https://github.com/logos-co/logos-lips/blob/master/docs/anoncomms/raw/mix.md#4-sphinx-packet-format).
...
Each waku node that supports the `mix intermediary or exit role` SHOULD indicate the same in its discoverable [ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/31/enr.md).
The following fields MUST be set as part of the discoverable ENR of a mix waku node:

- The `bit 5` in the [waku2 ENR key](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/31/enr.md#waku2-enr-key) is reserved to indicate `mix` support. This bit MUST be set to true to indicate `mix` support.
...
- Integration of [waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md) with mix.
...
- [waku lightpush](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/19/lightpush.md)
- [waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md)
- [ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/31/enr.md)
