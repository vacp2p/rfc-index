...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/raw/relay-sharding.md) — chore: split ift ts specs (#334)
- **2026-05-07** — [`48600b5`](https://github.com/logos-co/logos-lips/blob/48600b5b4fcdcb89f3d556ee0e4d417526f2919a/docs/messaging/standards/core/relay-sharding.md) — Migrate logos-messaging/specs into docs/messaging/ (#315)

<!-- timeline:end -->

## Abstract

This document describes ways of sharding the [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md) topic,
...
With this, the number of [Waku relay](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md) content topics that can be carried over a pubsub topic is limited.
...
It is RECOMMENDED for App protocols to follow the naming structure detailed in [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/draft/23/topics.md).
...
The informational RFC [WAKU2-RELAY-STATIC-SHARD-ALLOC](../../informational/raw/relay-static-shard-alloc.md) lists the current index allocations.
...
Since the introduction of [the Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/64/network.md),
...
> _Note_: Because _all_ shards distribute payload defined in [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md) via [protocol buffers](https://developers.google.com/protocol-buffers/),
...
to discover peers that are part of shards via [33/WAKU2-DISCV5](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/33/discv5.md) as well as via DNS.
...
An example is [the Waku Network](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/64/network.md).
To use autosharding,
...
Content topics MUST follow the format in [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/draft/23/topics.md#content-topic-format).
...
We currently use [33/WAKU2-DISCV5](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/33/discv5.md) for discovery,
...
See [WAKU2-ADVERSARIAL-MODELS](../../informational/raw/adversarial-models.md), especially the parts on k-anonymity.
...
- [11/WAKU2-RELAY](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/11/relay.md)
- [Unstructured P2P network](https://en.wikipedia.org/wiki/Peer-to-peer#Unstructured_networks)
- [33/WAKU2-DISCV5](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/33/discv5.md)
- [WAKU2-ENR](../draft/31/enr.md)
- [23/WAKU2-TOPICS](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/informational/draft/23/topics.md)
...
- [WAKU2-RELAY-STATIC-SHARD-ALLOC](../../informational/raw/relay-static-shard-alloc.md)
- [14/WAKU2-MESSAGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/stable/14/message.md)
- [64/WAKU2-NETWORK](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/64/network.md)
