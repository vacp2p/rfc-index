...
[`14/WAKU2-MESSAGE`](../../../../stable/14/message.md) affects `13/WAKU2-STORE` as well.
...
and `payload` fields of a `WakuMessage` (see [14/WAKU2-MESSAGE](../../../../stable/14/message.md)).
...
- `contentTopic` represents the content topic of the queried historical `WakuMessage`.
  This field maps to the `contentTopic` field of the [14/WAKU2-MESSAGE](../../../../stable/14/message.md).
...
This field maps to `topicIDs` field of `Message` in [`11/WAKU2-RELAY`](../../../../stable/11/relay.md).
...
these are [14/WAKU2-MESSAGE](../../../../stable/14/message.md) types.
...
to retrieve the next page of the [14/WAKU2-MESSAGE](../../../../stable/14/message.md).
...
without disclosing the exact topics of [14/WAKU2-MESSAGE](../../../../stable/14/message.md)
...
content topics of [14/WAKU2-MESSAGE](../../../../stable/14/message.md).
...
1. [14/WAKU2-MESSAGE](../../../../stable/14/message.md)
2. [protocol buffers v3](https://developers.google.com/protocol-buffers/)
3. [11/WAKU2-RELAY](../../../../stable/11/relay.md)
