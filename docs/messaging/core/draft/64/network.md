...
[11/WAKU2-RELAY](../../stable/11/relay.md) with spam protection measures.
...
defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/relay-sharding.md)
with:
...
as described in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/relay-sharding.md#discovery).
...
4. [WAKU2-PEER-EXCHANGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/draft/34/peer-exchange.md)
...
All payload on the Waku Network MUST be encapsulated in a [14/WAKU2-MESSAGE](../../stable/14/message.md)
...
If present, will form part of the message uniqueness vector described in [14/WAKU2-MESSAGE](../../stable/14/message.md).
...
for [14/WAKU2-MESSAGE](../../stable/14/message.md) published to the network.
...
If a message fails to decode as a valid [14/WAKU2-MESSAGE](../../stable/14/message.md),
...
as defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/relay-sharding.md#automatic-sharding)
...
defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/relay-sharding.md#content-topics-format-for-autosharding)
...
using the hashing mechanism defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/relay-sharding.md#automatic-sharding).
...
* [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/core/raw/relay-sharding.md)
* [66/WAKU2-METADATA](../66/metadata.md)
