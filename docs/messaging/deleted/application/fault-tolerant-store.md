...
<!-- timeline:end -->
 ...
 The reliability of [13/WAKU2-STORE](../../draft/core/13/store.md)
...
## Method description
 ...
 As the first step
towards making the [13/WAKU2-STORE](../../draft/core/13/store.md) protocol fault-tolerant,
...
We extend the [HistoryQuery](../../draft/core/13/store.md#payloads) protobuf message
...
[`HistoryResponse`](../../draft/core/13/store.md#store-query-response)
MUST contain historical waku messages whose
[`timestamp`](../../stable/core/14/message.md#message-attributes)
...
[`HistoryResponse`](../../draft/core/13/store.md#store-query-response)
MUST contain historical waku messages whose
[`timestamp`](../../stable/core/14/message.md#message-attributes) is less than or equal to the `end_time`.
...
- [13/WAKU2-STORE](../../draft/core/13/store.md)
- [`timestamp`](../../stable/core/14/message.md#message-attributes)
