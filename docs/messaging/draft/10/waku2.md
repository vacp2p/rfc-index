...
Historically, it has its roots in [6/WAKU1](/messaging/stable/6/waku1.md),
...
please see the [30/ADAPTIVE-NODES](/messaging/draft/30/adaptive-nodes.md) spec.
...
- [14/WAKU2-MESSAGE](/messaging/stable/14/message.md) and
[26/WAKU-PAYLOAD](/messaging/draft/26/payload.md) for message payloads
- [23/WAKU2-TOPICS](/messaging/draft/23/topics.md) and
[27/WAKU2-PEERS](/messaging/draft/27/peers.md) for recommendations around usage
...
The semantics of these protocols are referred to by RFC ID [17/WAKU2-RLN-RELAY](/messaging/draft/17/rln-relay.md) and [34/WAKU2-PEER-EXCHANGE](/messaging/draft/34/peer-exchange.md).
...
See [11/WAKU2-RELAY](/messaging/stable/11/relay.md) specification for more details.

For an experimental privacy-preserving economic spam protection mechanism,
see [17/WAKU2-RLN-RELAY](/messaging/draft/17/rln-relay.md).

See [23/WAKU2-TOPICS](/messaging/draft/23/topics.md)
...
[WAKU2-ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/31/enr.md)
...
See [13/WAKU2-STORE spec](/messaging/draft/13/store.md) specification for more details.
...
See [21/WAKU2-FAULT-TOLERANT-STORE](/messaging/deleted/fault-tolerant-store.md)
...
See [12/WAKU2-FILTER](/messaging/draft/12/filter.md) specification for more details.
...
See [19/WAKU2-LIGHTPUSH](/messaging/draft/19/lightpush.md) specification for more details.
...
see [11/WAKU2-RELAY](/messaging/stable/11/relay.md) for details.
Ditto for [13/WAKU2-STORE](/messaging/draft/13/store.md)
...
See [14/WAKU2-MESSAGE](/messaging/stable/14/message.md) for more details.
If WakuMessage version is set to 1,
we use the [6/WAKU1](/messaging/stable/6/waku1.md) compatible `data` field with encryption.
See [7/WAKU-DATA](/messaging/stable/7/data.md) for more details.
...
See [12/WAKU2-FILTER](/messaging/draft/12/filter.md) for more details.
...
See [11/WAKU2-RELAY](/messaging/stable/11/relay.md).

4. Node D saves `msg1` for possible later retrieval by other nodes.
See [13/WAKU2-STORE](/messaging/draft/13/store.md).

5. Node D also pushes `msg1` to F,
as it has previously subscribed F to this filter.
See [12/WAKU2-FILTER](/messaging/draft/12/filter.md).
...
[6/WAKU1](/messaging/stable/6/waku1.md) and Waku are different protocols all together.
They use a different transport protocol underneath;
[6/WAKU1](/messaging/stable/6/waku1.md) is devp2p RLPx based while Waku uses libp2p.
...
See [15/WAKU-BRIDGE](/messaging/draft/15/bridge.md) for details on a bidirectional bridge mode.
...
The [Publisher-Message Unlinkability](/messaging/stable/11/relay.md#security-analysis)
...
The [Subscriber-Topic Unlinkability](/messaging/stable/11/relay.md#security-analysis)
...
| ---- | -------------- | ------------ | ----------------- | -------------------- |
|[6/WAKU1](/messaging/stable/6/waku1.md)|✔||||
|[7/WAKU-DATA](/messaging/stable/7/data.md)|✔|✔|||
|[8/WAKU-MAIL](/messaging/stable/8/mail.md)|✔||||
|[9/WAKU-RPC](/messaging/stable/9/rpc.md)|✔||||
...
|[15/WAKU2-BRIDGE](/messaging/draft/15/bridge.md)|✔||||
|[16/WAKU2-RPC](/messaging/deprecated/16/rpc.md)|✔||||
|[17/WAKU2-RLN-RELAY](/messaging/draft/17/rln-relay.md)|🚧||||
|[18/WAKU2-SWAP](/messaging/deprecated/18/swap.md)|🚧||||
|[19/WAKU2-LIGHTPUSH](/messaging/draft/19/lightpush.md)|✔|✔|✔\**|✔\**|
|[21/WAKU2-FAULT-TOLERANT-STORE](/messaging/deleted/fault-tolerant-store.md)|✔|✔|||

*js-waku implements [13/WAKU2-STORE](/messaging/draft/13/store.md) as a querying node only.
**js-waku only implements [19/WAKU2-LIGHTPUSH](/messaging/draft/19/lightpush.md) requests.
...
- [10/WAKU2](/messaging/draft/10/waku2.md) - this specification
- [11/WAKU2-RELAY](/messaging/stable/11/relay.md) - for basic operation
- [14/WAKU2-MESSAGE](/messaging/stable/14/message.md) - version 0 (unencrypted)
- [13/WAKU2-STORE](/messaging/draft/13/store.md) - for historical messaging (query mode only)

To get compatibility with Waku Legacy:

- [7/WAKU-DATA](/messaging/stable/7/data.md)
- [14/WAKU2-MESSAGE](/messaging/stable/14/message.md) - version 1 (encrypted with `7/WAKU-DATA`)
...
More details on this can be found in [17/WAKU2-RLN-RELAY](/messaging/draft/17/rln-relay.md).
...
DoS attack is to be mitigated through the accounting model as described in [18/WAKU2-SWAP](/messaging/deprecated/18/swap.md).
...
See [18/WAKU2-SWAP](/messaging/deprecated/18/swap.md)
...
2. [6/WAKU1](/messaging/stable/6/waku1.md)

3. [Whisper spec (EIP627)](https://eips.ethereum.org/EIPS/eip-627)

4. [Waku v2 plan](https://vac.dev/waku-v2-plan)

5. [30/ADAPTIVE-NODES](/messaging/draft/30/adaptive-nodes.md)

6. [Protocol Identifiers](https://docs.libp2p.io/concepts/protocols/)

7. [14/WAKU2-MESSAGE](/messaging/stable/14/message.md)

8. [26/WAKU-PAYLOAD](/messaging/draft/26/payload.md)

9. [23/WAKU2-TOPICS](/messaging/draft/23/topics.md)

10. [27/WAKU2-PEERS](/messaging/draft/27/peers.md)
...
13. [11/WAKU2-RELAY spec](/messaging/stable/11/relay.md)

14. [17/WAKU2-RLN-RELAY](/messaging/draft/17/rln-relay.md)
...
18. [WAKU2-ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/31/enr.md)

19. [EIP-778 ENR (Ethereum Node Records)](https://eips.ethereum.org/EIPS/eip-778)

20. [13/WAKU2-STORE spec](/messaging/draft/13/store.md)

21. [21/WAKU2-FT-STORE](/messaging/deleted/fault-tolerant-store.md)

22. [12/WAKU2-FILTER](/messaging/draft/12/filter.md)

23. [19/WAKU2-LIGHTPUSH](/messaging/draft/19/lightpush.md)

24. [7/WAKU-DATA](/messaging/stable/7/data.md)

25. [15/WAKU-BRIDGE](/messaging/draft/15/bridge.md)
...
32. [9/WAKU-RPC](/messaging/stable/9/rpc.md)

33. [16/WAKU2-RPC](../../deprecated/16/rpc.md)

34. [18/WAKU2-SWAP spec](/messaging/deprecated/18/swap.md)

35. [21/WAKU2-FAULT-TOLERANT-STORE](/messaging/deleted/fault-tolerant-store.md)
