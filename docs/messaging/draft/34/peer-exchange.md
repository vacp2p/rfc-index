...
such as [33/WAKU2-DISCV5](/messaging/draft/33/discv5.md).
...
This protocol SHOULD only be used if [33/WAKU2-DISCV5](/messaging/draft/33/discv5.md) is infeasible.
...
The responder replies with a list of ENRs as specified in [WAKU2-ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/31/enr.md).
...
The `enr` field contains a Waku ENR as specified in [WAKU2-ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/31/enr.md).
...
mesh network.
The RECOMMENDED value for this outbound degree is 6 (see parameter `D` in [29/WAKU2-CONFIG](/messaging/draft/29/config.md)).
...
e.g. by requesting a random peer set via [33/WAKU2-DISCV5](/messaging/draft/33/discv5.md).
...
The response field contains ENRs as specified in [WAKU2-ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/31/enr.md).
While ENRs contain signatures, they do not violate the [Waku relay no-sign policy](/messaging/stable/11/relay.md#signature-policy),
...
* [libp2p gossipsub](https://github.com/libp2p/specs/blob/master/pubsub/gossipsub/gossipsub-v1.1.md)
* [29/WAKU2-CONFIG](/messaging/draft/29/config.md)
* [Waku Relay Anonymity](https://vac.dev/wakuv2-relay-anon)
* [Waku relay no-sign policy](/messaging/stable/11/relay.md#signature-policy)
