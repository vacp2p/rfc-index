...
In [10/WAKU2 spec](/messaging/draft/10/waku2.md) there are two types of topics:
...
Pubsub topics are used for routing of messages (see [11/WAKU2-RELAY](/messaging/stable/11/relay.md)),
and can be named implicitly by Waku sharding (see [RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md)).
This document comprises recommendations for explicitly naming pubsub topics
(e.g. when choosing *named sharding* as specified in [RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md)).
...
The following is an example of named sharding, as specified in [RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md).
...
See [14/WAKU2-MESSAGE spec](/messaging/stable/14/message.md)
...
[12/WAKU2-FILTER](/messaging/draft/12/filter.md) and
...
To bridge Waku v1 and Waku v2 we have a [15/WAKU-BRIDGE](/messaging/draft/15/bridge.md).
...
`/rfc26` indicates that the bridged content is encoded according to RFC [26/WAKU2-PAYLOAD](/messaging/draft/26/payload.md).
See [15/WAKU-BRIDGE](/messaging/draft/15/bridge.md)
...
- [15/WAKU-BRIDGE](/messaging/draft/15/bridge.md)
