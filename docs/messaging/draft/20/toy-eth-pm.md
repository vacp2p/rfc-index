...
5. Bob SHOULD be able to get `M` using [10/WAKU2](../10/waku2.md)
...
This MUST be wrapped in a [14/WAKU-MESSAGE](/messaging/stable/14/message.md) version 0,
...
Moreover, nwaku, the reference implementation of [13/WAKU2-STORE](/messaging/draft/13/store.md),
...
retrieved via [10/WAKU2](/messaging/draft/10/waku2.md),
