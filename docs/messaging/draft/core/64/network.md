...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/draft/64/network.md) — chore: split ift ts specs (#334)
- **2026-05-08** — [`c0ef3b9`](https://github.com/logos-co/logos-lips/blob/c0ef3b965ce844c4ad757832cce9e082b8435b01/docs/messaging/standards/core/64/network.md) — Cleanup: rewrite specs-repo links in pre-existing messaging specs (#316)
- **2026-04-20** — [`c3d15a9`](https://github.com/logos-co/logos-lips/blob/c3d15a9c7c24b4d6b0eb4fb578f9670ede6f69b0/docs/messaging/standards/core/64/network.md) — COSS overhaul: new statuses, CFR type, raw-spec leniency (#308)
- **2026-04-15** — [`5a3e844`](https://github.com/logos-co/logos-lips/blob/5a3e844679a0ac60e6b4e945a64c2f7d8650cba5/docs/messaging/standards/core/64/network.md) — Chore/move repo into logos co (#312)
...
[11/WAKU2-RELAY](../../../stable/core/11/relay.md) with spam protection measures.
...
defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md)
with:
...
as described in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md#discovery).
...
4. [WAKU2-PEER-EXCHANGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/core/34/peer-exchange.md)
...
All payload on the Waku Network MUST be encapsulated in a [14/WAKU2-MESSAGE](../../../stable/core/14/message.md)
...
If present, will form part of the message uniqueness vector described in [14/WAKU2-MESSAGE](../../../stable/core/14/message.md).
...
Any [14/WAKU2-MESSAGE](../../../stable/core/14/message.md) published to the network
...
for [14/WAKU2-MESSAGE](../../../stable/core/14/message.md) published to the network.
...
If a message fails to decode as a valid [14/WAKU2-MESSAGE](../../../stable/core/14/message.md),
...
as defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md#automatic-sharding)
...
defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md#content-topics-format-for-autosharding)
...
using the hashing mechanism defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md#automatic-sharding).
...
* [11/WAKU2-RELAY](../../../stable/core/11/relay.md)
* [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/core/relay-sharding.md)
* [66/WAKU2-METADATA](../66/metadata.md)
