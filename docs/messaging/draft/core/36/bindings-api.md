...
1. `char* messageJson`:
JSON string containing the [Waku Message](../../../stable/core/14/message.md)
...
1. `char* messageJson`:
JSON string containing the [Waku Message](../../../stable/core/14/message.md) as [`JsonMessage`](#jsonmessage-type).
2. `char* pubsubTopic`: pubsub topic on which to publish the message.
   If `NULL`, it uses the default pubsub topic.
