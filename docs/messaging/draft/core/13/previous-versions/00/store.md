...
- **2026-05-11** — [`1ac7689`](https://github.com/logos-co/logos-lips/blob/1ac7689ee3fe1665d5d5d1bf9c180ed951cc660d/docs/messaging/draft/13/previous-versions/00/store.md) — chore: split ift ts specs (#334)
- **2026-04-20** — [`c3d15a9`](https://github.com/logos-co/logos-lips/blob/c3d15a9c7c24b4d6b0eb4fb578f9670ede6f69b0/docs/messaging/standards/core/13/previous-versions/00/store.md) — COSS overhaul: new statuses, CFR type, raw-spec leniency (#308)
- **2026-02-09** — [`afd94c8`](https://github.com/logos-co/logos-lips/blob/afd94c8bc1420376ae9af7e14a4feb246f2ed621/docs/messaging/standards/core/13/previous-versions/00/store.md) — chore: add math support (#287)
- **2026-01-16** — [`f01d5b9`](https://github.com/logos-co/logos-lips/blob/f01d5b9d9f2ef977b8c089d616991b24f2ee4efe/docs/messaging/standards/core/13/previous-versions/00/store.md) — chore: fix links (#260)
- **2026-01-16** — [`89f2ea8`](https://github.com/logos-co/logos-lips/blob/89f2ea89fc1d69ab238b63c7e6fb9e4203fd8529/docs/messaging/standards/core/13/previous-versions/00/store.md) — Chore/mdbook updates (#258)
- **2025-12-22** — [`0f1855e`](https://github.com/logos-co/logos-lips/blob/0f1855edcf68ef982c4ce478b67d660809aa9830/docs/waku/standards/core/13/previous-versions/00/store.md) — Chore/fix headers (#239)
- **2025-12-22** — [`b1a5783`](https://github.com/logos-co/logos-lips/blob/b1a578393edf8487ccc97a5f25b25af9bf41efb3/docs/waku/standards/core/13/previous-versions/00/store.md) — Chore/mdbook updates (#237)
- **2025-12-18** — [`d03e699`](https://github.com/logos-co/logos-lips/blob/d03e699084774ebecef9c6d4662498907c5e2080/docs/waku/standards/core/13/previous-versions/00/store.md) — ci: add mdBook configuration (#233)
- **2025-02-03** — [`a60a2c4`](https://github.com/logos-co/logos-lips/blob/a60a2c45de49966c3550e0f5efe2fa4b081dd40f/waku/standards/core/13/previous-versions/00/store.md) — 13/WAKU-STORE: Update (#124)
...
[`14/WAKU2-MESSAGE`](../../../../../stable/core/14/message.md) affects `13/WAKU2-STORE` as well.
Nodes running `13/WAKU2-STORE` SHOULD support `ephemeral` messages as specified in
[14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md).
...
and `payload` fields of a `WakuMessage` (see [14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md)).
...
- `contentTopic` represents the content topic of the queried historical `WakuMessage`.
  This field maps to the `contentTopic` field of the [14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md).
...
This field maps to `topicIDs` field of `Message` in [`11/WAKU2-RELAY`](../../../../../stable/core/11/relay.md).
...
these are [14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md) types.
...
to retrieve the next page of the [14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md).
...
without disclosing the exact topics of [14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md)
...
content topics of [14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md).
...
1. [14/WAKU2-MESSAGE](../../../../../stable/core/14/message.md)
2. [protocol buffers v3](https://developers.google.com/protocol-buffers/)
3. [11/WAKU2-RELAY](../../../../../stable/core/11/relay.md)
