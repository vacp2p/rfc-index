...
This is a more lightweight version of [11/WAKU2-RELAY](/messaging/stable/core/11/relay.md),
...
Unlike the [13/WAKU2-STORE](/messaging/draft/core/13/store.md) protocol
...
[13/WAKU2-STORE](/messaging/draft/core/13/store.md) protocol to
...
A [14/WAKU2-MESSAGE](/messaging/stable/core/14/message.md) matches filter criteria
...
These [`WakuMessage`s](/messaging/stable/core/14/message.md)
are likely to come from [`11/WAKU2-RELAY`](/messaging/stable/core/11/relay.md),
