...
[10/WAKU2](/messaging/draft/10/waku2.md) uses the `33/WAKU2-DISCV5` ambient node discovery network
...
of an efficient discovery method for [10/WAKU2](/messaging/draft/10/waku2.md).
...
[11/WAKU2-RELAY](/messaging/stable/11/relay.md) assumes the existence of a network of Waku2 nodes.
...
[10/WAKU2](/messaging/draft/10/waku2.md) supports the following discovery methods
...
* [`34/WAKU2-PEER-EXCHANGE`](/messaging/draft/34/peer-exchange.md)
* `33/WAKU2-DISCV5` (specified in this document)

The purpose of ambient node discovery within [10/WAKU2](/messaging/draft/10/waku2.md)
...
network [11/WAKU2-RELAY](/messaging/stable/11/relay.md) builds on.
...
and filtering Waku nodes based on whether they support [WAKU2-ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/31/enr.md).
...
2. [`34/WAKU2-PEER-EXCHANGE`](/messaging/draft/34/peer-exchange.md)
3. [11/WAKU2-RELAY](/messaging/stable/11/relay.md)
4. [WAKU2-ENR](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/31/enr.md)
