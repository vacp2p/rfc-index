...
defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md)
with:
...
as described in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md#discovery).
...
4. [WAKU2-PEER-EXCHANGE](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/draft/34/peer-exchange.md)
...
as defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md#automatic-sharding)
...
defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md#content-topics-format-for-autosharding)
...
using the hashing mechanism defined in [WAKU2-RELAY-SHARDING](https://github.com/logos-co/logos-lips/blob/master/docs/messaging/raw/relay-sharding.md#automatic-sharding).
