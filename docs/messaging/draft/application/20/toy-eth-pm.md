...
This MUST be wrapped in a [14/WAKU-MESSAGE](/messaging/stable/core/14/message.md) version 0,
...
Moreover, nwaku, the reference implementation of [13/WAKU2-STORE](/messaging/draft/core/13/store.md),
...
retrieved via [10/WAKU2](/messaging/draft/core/10/waku2.md),
