...
Create a content topic string according to [RFC 23](../23/topics.md).
...
- 0 - The operation was completed successfuly.
`onOkCb` will receive the content topic formatted according to [RFC 23](../23/topics.md):
...
Create a pubsub topic string according to [RFC 23](../23/topics.md).
...
- 0 - The operation was completed successfuly.
`onOkCb` will get populated with a pubsub topic formatted according to [RFC 23](../23/topics.md):
