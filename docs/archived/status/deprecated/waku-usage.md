...
- **2026-01-19** — [`f24e567`](https://github.com/vacp2p/rfc-index/blob/f24e567d0b1e10c178bfa0c133495fe83b969b76/docs/archived/status/deprecated/waku-usage.md) — Chore/updates mdbook (#262)
- **2026-01-16** — [`f01d5b9`](https://github.com/vacp2p/rfc-index/blob/f01d5b9d9f2ef977b8c089d616991b24f2ee4efe/docs/archived/status/deprecated/waku-usage.md) — chore: fix links (#260)
- **2026-01-16** — [`89f2ea8`](https://github.com/vacp2p/rfc-index/blob/89f2ea89fc1d69ab238b63c7e6fb9e4203fd8529/docs/archived/status/deprecated/waku-usage.md) — Chore/mdbook updates (#258)
- **2025-12-22** — [`0f1855e`](https://github.com/vacp2p/rfc-index/blob/0f1855edcf68ef982c4ce478b67d660809aa9830/docs/status/deprecated/waku-usage.md) — Chore/fix headers (#239)
- **2025-12-22** — [`b1a5783`](https://github.com/vacp2p/rfc-index/blob/b1a578393edf8487ccc97a5f25b25af9bf41efb3/docs/status/deprecated/waku-usage.md) — Chore/mdbook updates (#237)
- **2025-12-18** — [`d03e699`](https://github.com/vacp2p/rfc-index/blob/d03e699084774ebecef9c6d4662498907c5e2080/docs/status/deprecated/waku-usage.md) — ci: add mdBook configuration (#233)
- **2025-04-29** — [`614348a`](https://github.com/vacp2p/rfc-index/blob/614348a4982aa9e519ccff8b8fbcd4c554683288/status/deprecated/waku-usage.md) — Status deprecated update2 (#134)
...
| -------------------- | ---: | --- |
| Status               |    0 | [Status](../README.md), [WAKU-1](/messaging/standards/legacy/6/waku1.md#status) |
| Messages             |    1 | [WAKU-1](/messaging/standards/legacy/6/waku1.md#messages) |
| Batch Ack            |   11 | Undocumented. Marked for Deprecation |
| Message Response     |   12 | [WAKU-1](/messaging/standards/legacy/6/waku1.md#batch-ack-and-message-response) |
| Status Update        |   22 | [WAKU-1](/messaging/standards/legacy/6/waku1.md#status-update) |
| P2P Request Complete |  125 | [4/WAKU-MAILSERVER](/archived/status/deprecated/waku-mailserver.md) |
| P2P Request          |  126 | [4/WAKU-MAILSERVER](/archived/status/deprecated/waku-mailserver.md), [WAKU-1](/messaging/standards/legacy/6/waku1.md#p2p-request) |
| P2P Messages         |  127 | [4/WAKU-MAILSERVER](/archived/status/deprecated/waku-mailserver.md), [WAKU-1](/messaging/standards/legacy/6/waku1.md#p2p-request-complete) |
...
| ----------------------- | ------ | -------- | ----------- | --- |
| `pow-requirement`       | `0x00` | `uint64` | minimum PoW accepted by the peer | [WAKU-1#pow-requirement](/messaging/standards/legacy/6/waku1.md#pow-requirement-field) |
| `bloom-filter`          | `0x01` | `[]byte` | bloom filter of Waku topic accepted by the peer | [WAKU-1#bloom-filter](/messaging/standards/legacy/6/waku1.md#bloom-filter-field) |
| `light-node`            | `0x02` | `bool`   | when true, the peer won't forward envelopes through the Messages packet. | [WAKU-1#light-node](/messaging/standards/legacy/6/waku1.md#light-node) |
| `confirmations-enabled` | `0x03` | `bool`   | when true, the peer will send message confirmations | [WAKU-1#confirmations-enabled-field](/messaging/standards/legacy/6/waku1.md#confirmations-enabled-field) |
| `rate-limits`           | `0x04` |          | See [Rate limiting](/messaging/standards/legacy/6/waku1.md#rate-limits-field) | [WAKU-1#rate-limits](/messaging/standards/legacy/6/waku1.md#rate-limits-field) |
| `topic-interest`        | `0x05` | `[10000][4]byte` | Topic interest is used to share a node's interest in envelopes with specific topics. It does this in a more bandwidth considerate way, at the expense of some metadata protection. Peers MUST only send envelopes with specified topics. | [WAKU-1#topic-interest](/messaging/standards/legacy/6/waku1.md#topic-interest-field), [the theoretical scaling model](https://github.com/vacp2p/research/tree/dcc71f4779be832d3b5ece9c4e11f1f7ec24aac2/whisper_scalability) |
...
Keys management for PFS is described in [5/SECURE-TRANSPORT](/archived/status/deprecated/secure-transport.md).
...
* Created document
* Forked from [3-whisper-usage](whisper-usage.md)
...
* [Waku](../../../messaging/README.md)
* [WAKU1](/messaging/standards/legacy/6/waku1.md)
