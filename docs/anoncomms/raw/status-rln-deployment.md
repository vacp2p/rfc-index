...
for the TX due to the [multi-message_id burn RLN](https://lip.logos.co/anoncomms/raw/multi-message_id-burn-rln.html).
...
- [RLN Specification](https://lip.logos.co/anoncomms/raw/rln-v2.html)
- [Multi-message_id burn RLN](https://lip.logos.co/anoncomms/raw/multi-message_id-burn-rln.html)
