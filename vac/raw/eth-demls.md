...
While SIWE provides a robust foundation for Ethereum-based authentication,
it presents certain challenges in a decentralized context,
particularly regarding nonce generation through smart contracts.
The need for oracles or the reliance on deterministic pseudo-random nonces
derived from on-chain data introduces potential security vulnerabilities.
...
[SimpleLogin](https://github.com/vacp2p/rfc-index/blob/eth-secpm-alt_authentication/vac/raw/eth-simplelogin.md) provides a blockchain-based authentication system
...
User registration and authentication MUST be implemented following the specification described [here](https://github.com/vacp2p/rfc-index/blob/eth-secpm-alt_authentication/vac/raw/eth-simplelogin.md).
