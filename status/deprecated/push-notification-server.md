...
A `PNR message` (Push Notification Registration) MUST be sent to the [partitioned topic](https://rfc.vac.dev/status/deprecated/waku-usage/#partitioned-topic)
for the public key of the node, encrypted with this key.

The message MUST be wrapped in a [`ApplicationMetadataMessage`](https://rfc.vac.dev/status/deprecated/payload/#payload-wrapper) with type set to `PUSH_NOTIFICATION_REGISTRATION`.
...
The response MUST be sent on the [partitioned topic](https://rfc.vac.dev/status/deprecated/waku-usage.md#partitioned-topic) of the sender
and MUST not be encrypted using the [secure transport](https://rfc.vac.dev/status/deprecated/secure-transport) to facilitate the usage of ephemeral keys.
...
A client SHOULD listen for a response sent on the [partitioned topic](https://rfc.vac.dev/status/deprecated/waku-usage/#partitioned-topic)
...
Using the topic derivation algorithm described [here](https://rfc.vac.dev/status/deprecated/waku-usage/#public-chats)
...
The message MUST be wrapped in a [`ApplicationMetadataMessage`](https://rfc.vac.dev/status/deprecated/payloads/#payload-wrapper) with type set to `PUSH_NOTIFICATION_QUERY_INFO`.
...
To discover a push notification service for a given user, their [contact code topic](https://rfc.vac.dev/status/deprecated/waku-usage/#contact-code-topic)
...
The message MUST be wrapped in a [`ApplicationMetadataMessage`](https://rfc.vac.dev/status/deprecated/payloads/#payload-wrapper) with type set to `PUSH_NOTIFICATION_QUERY`.
...
The response MUST be sent on the [partitioned topic](https://rfc.vac.dev/status/deprecated/waku-usage/#partitioned-topic) of the sender
...
A `PushNotificationResponse` message MUST be wrapped in a [`ApplicationMetadataMessage`](https://rfc.vac.dev/status/deprecated/payloads/payload-wrapper) with type set to `PUSH_NOTIFICATION_RESPONSE`.

Where `message_id` is the `message_id` sent by the client.

The response MUST be sent on the [partitioned topic](https://rfc.vac.dev/status/deprecated/waku-usage/#partitioned-topic) of the sender
and MUST not be encrypted using the [secure transport](https://rfc.vac.dev/status/deprecated/secure-transport) to facilitate
the usage of ephemeral keys.
...
`installation_id`: the [`installation_id`](https://rfc.vac.dev/status/deprecated/account) of the device
...
A client MAY share their public key through [contact updates](https://rfc.vac.dev/status/deprecated/payloads/contact-update)
...
This can be mitigated by [device syncing](https://rfc.vac.dev/status/deprecated/payloads), but not completely
addressed.
...
- [Partitioned Topic](https://rfc.vac.dev/status/deprecated/waku-usage/#partitioned-topic)
- [Push Notification Payload Wrapper](https://rfc.vac.dev/status/deprecated/payloads/#payload-wrapper)
- [Push Notification Query Topic](https://rfc.vac.dev/status/deprecated/waku-usage/#partitioned-topic)
- [Push Notification Response](https://rfc.vac.dev/status/deprecated/payloads/payload-wrapper)
...
- [Waku Contact Code Topic](https://rfc.vac.dev/status/deprecated/waku-usage/#contact-code-topic)
- [Waku Public Chats](https://rfc.vac.dev/status/deprecated/waku-usage/#public-chats)
- [ENS Contract](https://github.com/ensdomains/ens)
- [Payloads](https://rfc.vac.dev/status/deprecated/payloads)
- [Payload wrapper](https://rfc.vac.dev/status/deprecated/payload/#payload-wrapper)
