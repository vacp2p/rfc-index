...
FILE_ASSIGNMENTS = {
    ...
    "blockchain/deprecated/[1.0.0] Proof of Leadership.md": ("Consensus", "[1.0.0] Proof of Leadership"),
    ...
    "blockchain/deprecated/[1.0.0] [Overview] Bedrock Architecture.md": ("Mantle", "[1.0.0] [Overview] Bedrock Architecture"),
    "blockchain/raw/bedrock-v1.1-mantle-specification.md": ("Mantle", "Mantle"),
    "blockchain/deprecated/[1.4.0] Mantle.md": ("Mantle", "[1.4.0] Mantle"),
    "blockchain/deprecated/[1.3.0] Mantle.md": ("Mantle", "[1.3.0] Mantle"),
    "blockchain/deprecated/[1.2.1] Mantle.md": ("Mantle", "[1.2.1] Mantle"),
    "blockchain/deprecated/[1.2.0] Mantle.md": ("Mantle", "[1.2.0] Mantle"),
    "blockchain/deprecated/[1.1.0] Mantle.md": ("Mantle", "[1.1.0] Mantle"),
    "blockchain/deprecated/[1.0.0] Mantle.md": ("Mantle", "[1.0.0] Mantle"),
    "blockchain/raw/bedrock-v1.1-block-construction.md": ("Mantle", "Block Construction, Validation and Execution"),
    "blockchain/deprecated/[1.1.0] Block Construction, Validation and Execution.md": ("Mantle", "[1.1.0] Block Construction, Validation and Execution"),
    "blockchain/deprecated/[1.1.0] Block Construction, Validation and Execution_2.md": ("Mantle", "[1.1.0] Block Construction, Validation and Execution_2"),
    "blockchain/deprecated/[1.0.0] Block Construction, Validation and Execution.md": ("Mantle", "[1.0.0] Block Construction, Validation and Execution"),
    "blockchain/raw/bedrock-genesis-block.md": ("Mantle", "Bedrock Genesis Block"),
    "blockchain/deprecated/[1.1.0] Bedrock Genesis Block.md": ("Mantle", "[1.1.0] Bedrock Genesis Block"),
    "blockchain/deprecated/[1.0.0] Bedrock Genesis Block.md": ("Mantle", "[1.0.0] Bedrock Genesis Block"),
    ...
    "blockchain/deprecated/[1.1.0] Service Reward Distribution Protocol.md": ("Mantle", "[1.1.0] Service Reward Distribution Protocol"),
    "blockchain/deprecated/[1.0.0] Service Reward Distribution Protocol.md": ("Mantle", "[1.0.0] Service Reward Distribution Protocol"),
    ...
    "blockchain/deprecated/[1.3.0] Mantle Transaction Encoding.md": ("Mantle", "[1.3.0] Mantle Transaction Encoding"),
    "blockchain/deprecated/[1.2.0] Mantle Transaction Encoding.md": ("Mantle", "[1.2.0] Mantle Transaction Encoding"),
    "blockchain/deprecated/[1.1.0] Mantle Transaction Encoding.md": ("Mantle", "[1.1.0] Mantle Transaction Encoding"),
    "blockchain/deprecated/[1.0.0] Mantle Transaction Encoding.md": ("Mantle", "[1.0.0] Mantle Transaction Encoding"),
    "blockchain/raw/template-cross-channel-messaging.md": ("Mantle", "[Template] Cross-Channel Messaging"),
    "blockchain/deprecated/[1.1.0][Template] Cross-Channel Messaging.md": ("Mantle", "[1.1.0][Template] Cross-Channel Messaging"),
    "blockchain/deprecated/[1.0.0] [Template] Cross-Channel Messaging.md": ("Mantle", "[1.0.0] [Template] Cross-Channel Messaging"),
    "blockchain/raw/analysis-gas-cost-determination.md": ("Mantle", "[Analysis] Gas Cost Determination"),
    "blockchain/deprecated/[1.4.0][Analysis] Gas Cost Determination.md": ("Mantle", "[1.4.0][Analysis] Gas Cost Determination"),
    "blockchain/deprecated/[1.3.0] [Analysis] Gas Cost Determination.md": ("Mantle", "[1.3.0] [Analysis] Gas Cost Determination"),
    "blockchain/deprecated/[1.2.0] [Analysis] Gas Cost Determination.md": ("Mantle", "[1.2.0] [Analysis] Gas Cost Determination"),
    "blockchain/deprecated/[1.1.0] [Analysis] Gas Cost Determination.md": ("Mantle", "[1.1.0] [Analysis] Gas Cost Determination"),
    "blockchain/deprecated/[1.0.0] [Analysis] Gas Cost Determination.md": ("Mantle", "[1.0.0] [Analysis] Gas Cost Determination"),
    ...
    "blockchain/deprecated/[1.0.0] Proof of Quota.md": ("Blend Network", "[1.0.0] Proof of Quota"),
